quizzes = {
    "نفسية عملي": {
        ...
        "أسئلة عامة":[
            {"question":"Restlessness and inability to remain seated due to antipsychotics is:","options":["Akathisia","Dystonia","Parkinsonism","Tardive dyskinesia"],"answer":"Akathisia"},
            {"question":"Metabolic side effects are common with:","options":["Typical antipsychotics","Atypical antipsychotics","Antidepressants","Mood stabilizers"],"answer":"Atypical antipsychotics"},
            {"question":"Relapses in schizophrenia are most often due to:","options":["Poor medication adherence","Genetics","Diet","Sleep"],"answer":"Poor medication adherence"},
            {"question":"The active phase of schizophrenia includes:","options":["Delusions and hallucinations","Only depression","Only anxiety","Only memory loss"],"answer":"Delusions and hallucinations"},
            {"question":"Personality usually includes:","options":["Thinking, feeling, and behaving","Only emotions","Only thinking","Only behavior"],"answer":"Thinking, feeling, and behaving"},
            {"question":"Sudden painful muscle contractions due to antipsychotics are called:","options":["Akathisia","Acute dystonia","Tremor","Rigidity"],"answer":"Acute dystonia"},
            {"question":"Generalized anxiety disorder often presents with:","options":["Persistent and excessive worry about multiple areas","Only panic attacks","Hallucinations","Memory loss"],"answer":"Persistent and excessive worry about multiple areas"},
            {"question":"Clozapine is preferred for:","options":["Mild anxiety","Treatment-resistant schizophrenia","Depression","Insomnia"],"answer":"Treatment-resistant schizophrenia"},
            {"question":"Which is TRUE about personality disorders?","options":["They improve automatically","They cause functional impairment","They affect only mood","They are temporary"],"answer":"They cause functional impairment"},
            {"question":"Which statement about gender differences in schizophrenia is TRUE?","options":["Males have a less severe course","Females have a more severe course","No difference","Only females are affected"],"answer":"Males have a less severe course"},
            {"question":"Common anticholinergic side effects include:","options":["Dry mouth and constipation","Diarrhea and sweating","Fever and rash","Weight loss"],"answer":"Dry mouth and constipation"},
            {"question":"Prevalence of personality disorders is:","options":["1–5%","10–15%","20–30%","50%"],"answer":"10–15%"},
            {"question":"Catatonic schizophrenia is characterized by:","options":["Abnormal motor behavior","Memory loss","Hyperactivity","Sleep disturbance"],"answer":"Abnormal motor behavior"},
            {"question":"First management step for extrapyramidal symptoms is:","options":["Increase dose","Reduce dose or change medication","Stop treatment completely","Give antibiotics"],"answer":"Reduce dose or change medication"},
            {"question":"Many patients with personality disorders:","options":["Always seek treatment","Do not seek treatment","Are cured quickly","Have no symptoms"],"answer":"Do not seek treatment"},
            {"question":"Major symptoms of depression include:","options":["Low mood, loss of interest, and loss of energy","Hallucinations only","Increased energy","Aggression"],"answer":"Low mood, loss of interest, and loss of energy"},
            {"question":"Elderly patients with dementia using antipsychotics are at:","options":["Low risk","High risk for adverse effects","No risk","Moderate risk only"],"answer":"High risk for adverse effects"},
            {"question":"Cluster B personality disorders are:","options":["Calm and stable","Emotional and erratic","Anxious and fearful","Organized and controlled"],"answer":"Emotional and erratic"},
            {"question":"Catatonia in schizophrenia may present as:","options":["Stupor or unusual posturing","Fever","Hyperactivity","Normal movement"],"answer":"Stupor or unusual posturing"},
            {"question":"Cluster C personality disorders are:","options":["Emotional and erratic","Anxious and fearful","Aggressive","Psychotic"],"answer":"Anxious and fearful"},
            {"question":"Loss of motivation is called:","options":["Anhedonia","Avolition","Delusion","Compulsion"],"answer":"Avolition"},
            {"question":"Obsessive-compulsive personality disorder differs from OCD because it focuses on:","options":["Intrusive thoughts","Perfectionism","Hallucinations","Memory loss"],"answer":"Perfectionism"},
            {"question":"Severe anxiety disorders may lead to:","options":["Improved performance","Impairment in daily functioning","Increased energy","Better sleep"],"answer":"Impairment in daily functioning"},
            {"question":"Borderline personality disorder is mainly characterized by:","options":["Stable relationships","Unstable relationships and emotions","Memory loss","Hallucinations"],"answer":"Unstable relationships and emotions"},
            {"question":"Symptoms least responsive to antipsychotics are:","options":["Positive symptoms","Negative symptoms","Mood symptoms","Anxiety symptoms"],"answer":"Negative symptoms"},
            {"question":"A common symptom of anxiety is:","options":["Worry and fear","Hallucinations","Memory loss","Paralysis"],"answer":"Worry and fear"},
            {"question":"Loss of pleasure is called:","options":["Avolition","Anhedonia","Delusion","Obsession"],"answer":"Anhedonia"},
            {"question":"Disorganized speech and behavior without hallucinations may indicate:","options":["No disorder","Still possible schizophrenia","Depression only","Anxiety only"],"answer":"Still possible schizophrenia"},
            {"question":"Highest genetic risk for schizophrenia is in:","options":["Parents","Siblings","Identical twins","Friends"],"answer":"Identical twins"},
            {"question":"Anxiety disorders may include:","options":["Panic attacks and generalized anxiety disorder","Only depression","Only psychosis","Only insomnia"],"answer":"Panic attacks and generalized anxiety disorder"}, 
            {"question":"OCD is characterized by:","options":["Hallucinations","Obsessions and compulsions","Mood swings","Memory loss"],"answer":"Obsessions and compulsions"},
            {"question":"Hoarding disorder involves:","options":["Throwing away items easily","Difficulty discarding items leading to clutter","Cleaning behavior","Social withdrawal"],"answer":"Difficulty discarding items leading to clutter"},
            {"question":"Before diagnosing schizophrenia, clinicians must rule out:","options":["Depression","Substance-induced psychosis","Anxiety","Insomnia"],"answer":"Substance-induced psychosis"},
            {"question":"Obsessions are defined as:","options":["Controlled thoughts","Intrusive, unwanted thoughts","Pleasant ideas","Normal thinking"],"answer":"Intrusive, unwanted thoughts"},
            {"question":"Seeing things that are not present refers to:","options":["Delusion","Visual hallucinations","Illusion","Obsession"],"answer":"Visual hallucinations"},
            {"question":"Social anxiety disorder is characterized by:","options":["Fear of social situations and embarrassment","Aggression","Hallucinations","Memory loss"],"answer":"Fear of social situations and embarrassment"},
            {"question":"Compulsions are:","options":["Normal habits","Repetitive behaviors that cannot be controlled","Thoughts","Emotions"],"answer":"Repetitive behaviors that cannot be controlled"},
            {"question":"Avoidant personality disorder is marked by:","options":["Confidence","Extreme social inhibition and fear of rejection","Aggression","Impulsivity"],"answer":"Extreme social inhibition and fear of rejection"},
            {"question":"Narcissistic personality disorder shows:","options":["Low self-esteem","Grandiosity and need for admiration","Fearfulness","Withdrawal"],"answer":"Grandiosity and need for admiration"},
            {"question":"A patient washing hands repeatedly is considered:","options":["Obsession","Compulsion","Delusion","Hallucination"],"answer":"Compulsion"},
            {"question":"Schizoid personality disorder features:","options":["Detachment from social relationships","Emotional instability","Aggression","Impulsivity"],"answer":"Detachment from social relationships"},
            {"question":"First step in managing extrapyramidal symptoms is:","options":["Increase dose","Reduce dose or switch drug","Stop all medications","Give antibiotics"],"answer":"Reduce dose or switch drug"},
            {"question":"Schizophrenia is primarily diagnosed when symptoms persist for at least:","options":["1 month","3 months","6 months","1 year"],"answer":"6 months"},
            {"question":"Recurrent obsessions lead to:","options":["Happiness","Anxiety and restlessness","Relaxation","Sleep"],"answer":"Anxiety and restlessness"},
            {"question":"Lip smacking, grimacing, and repetitive movements from long-term antipsychotic use indicate:","options":["Akathisia","Acute dystonia","Tardive dyskinesia","Parkinsonism"],"answer":"Tardive dyskinesia"},
            {"question":"Patients perform compulsions to:","options":["Increase anxiety","Reduce anxiety","Improve memory","Cause hallucinations"],"answer":"Reduce anxiety"},
            {"question":"Intrusive thoughts that a patient cannot control are:","options":["Delusions","Obsessions","Compulsions","Hallucinations"],"answer":"Obsessions"},
            {"question":"Children with OCD:","options":["Always explain behaviors","May not explain behaviors","Have no symptoms","Are always aware of their condition"],"answer":"May not explain behaviors"},
            {"question":"Panic attacks usually last for:","options":["Several hours","Several days","Several minutes with intense fear","Weeks"],"answer":"Several minutes with intense fear"},
            {"question":"Hallucination is best described as:","options":["False belief","Impaired sensory perception","Normal thinking","Memory loss"],"answer":"Impaired sensory perception"},
            {"question":"Common physical symptoms of anxiety include:","options":["Sweating, palpitations, and trembling","Fever and rash","Paralysis","Vision loss"],"answer":"Sweating, palpitations, and trembling"},
            {"question":"Which condition must be ruled out before diagnosing schizophrenia?","options":["Depression","Addiction","Anxiety","Insomnia"],"answer":"Addiction"},
            {"question":"A patient checking locks repeatedly is showing:","options":["Obsession","Compulsion","Delusion","Hallucination"],"answer":"Compulsion"},
            {"question":"Which medication is primarily used to manage mania and impulsive violence?","options":["Fluoxetine","Lithium","Diazepam","Haloperidol"],"answer":"Lithium"},
            {"question":"Acute dystonia is best described as:","options":["Chronic tremor","Sudden muscle spasms","Memory loss","Slow movement"],"answer":"Sudden muscle spasms"},
            {"question":"Which case indicates the highest genetic risk for schizophrenia?","options":["Parents","Siblings","Identical twins","Friends"],"answer":"Identical twins"},
            {"question":"Contraindications of typical antipsychotics include:","options":["Hypersensitivity and Parkinsonism","Hypertension","Diabetes","Asthma"],"answer":"Hypersensitivity and Parkinsonism"},
            {"question":"Most common side effects of SSRIs are:","options":["Nausea and sexual dysfunction","Fever and rash","Weight loss only","Hair loss"],"answer":"Nausea and sexual dysfunction"},
            {"question":"Positive symptoms of schizophrenia include:","options":["Hallucinations and delusions","Social withdrawal","Lack of motivation","Flat affect"],"answer":"Hallucinations and delusions"},
            {"question":"Negative symptoms of schizophrenia include:","options":["Hallucinations","Delusions","Social withdrawal and lack of motivation","Aggression"],"answer":"Social withdrawal and lack of motivation"},
            {"question":"Anticholinergic side effects include:","options":["Blurred vision, dry mouth, and constipation","Sweating and fever","Hair loss","Weight loss"],"answer":"Blurred vision, dry mouth, and constipation"},
            {"question":"A patient developing tremors and rigidity after starting antipsychotics likely has:","options":["Akathisia","Parkinsonism","Dystonia","Tardive dyskinesia"],"answer":"Parkinsonism"},
            {"question":"A patient cannot sit still and keeps pacing. This indicates:","options":["Dystonia","Akathisia","Parkinsonism","Depression"],"answer":"Akathisia"},
            {"question":"Depression linked to the menstrual cycle is:","options":["Major depression","Premenstrual dysphoric disorder","Bipolar disorder","Anxiety disorder"],"answer":"Premenstrual dysphoric disorder"},
            {"question":"Personality disorders are most diagnosed in:","options":["Childhood","Adolescence and early adulthood","Old age","Infancy"],"answer":"Adolescence and early adulthood"},
            {"question":"Akathisia due to antipsychotics is mainly:","options":["Muscle rigidity","Restlessness and urge to move constantly","Memory loss","Sleep disturbance"],"answer":"Restlessness and urge to move constantly"},
            {"question":"Atypical antipsychotics are effective against:","options":["Positive symptoms only","Negative symptoms only","Positive and negative symptoms","Anxiety only"],"answer":"Positive and negative symptoms"},
            {"question":"Management of EPS may include:","options":["Stopping all drugs","Administering anticholinergic medication or adjusting dose","Increasing dose","Giving antibiotics"],"answer":"Administering anticholinergic medication or adjusting dose"},
            {"question":"Which is an example of psychological violence?","options":["Physical assault","Using language to make someone fearful","Providing support","Ignoring someone"],"answer":"Using language to make someone fearful"},
            {"question":"Mood disorders include:","options":["Only anxiety disorders","Bipolar and depressive disorders","Only psychotic disorders","Only personality disorders"],"answer":"Bipolar and depressive disorders"},
            {"question":"Long-term use of benzodiazepines carries a risk of dependence.","options":["True","False"],"answer":"True"},
            {"question":"Schizotypal personality disorder may include odd beliefs and unusual perceptual experiences.","options":["True","False"],"answer":"True"},
            {"question":"Benzodiazepines act by enhancing the effect of GABA in the brain.","options":["True","False"],"answer":"True"},
            {"question":"A depressed patient can be given electroconvulsive therapy during hospitalization.","options":["True","False"],"answer":"True"},
            {"question":"Occupational therapy helps patients improve daily living and vocational skills.","options":["True","False"],"answer":"True"},
            {"question":"MAOIs are drugs that inhibit the action of an enzyme called monoamine oxidase.","options":["True","False"],"answer":"True"},
            {"question":"Paranoid personality disorder patients often misinterpret others' intentions as harmful.","options":["True","False"],"answer":"True"},
            {"question":"A structured daily schedule is an important component of milieu therapy.","options":["True","False"],"answer":"True"},
            {"question":"Selective serotonin reuptake inhibitors (SSRIs) are primarily used to treat depression and long-term anxiety disorders.","options":["True","False"],"answer":"True"},
            {"question":"Verbal threats of suicide should always be taken seriously.","options":["True","False"],"answer":"True"},
            {"question":"Patients with depression may experience sleep disturbances such as insomnia or hypersomnia.","options":["True","False"],"answer":"True"},
            {"question":"Patients with mood disorders often show disturbances not only in emotions but also in cognition, behavior, and physical functioning.","options":["True","False"],"answer":"True"},
            {"question":"Psychiatric emergencies may include suicidal behavior and violent aggression.","options":["True","False"],"answer":"True"},
            {"question":"Akathisia is characterized by inner restlessness and inability to stay still.","options":["True","False"],"answer":"True"},
            {"question":"MAOIs require dietary restrictions to avoid hypertensive crisis.","options":["True","False"],"answer":"True"},
            {"question":"One of the nursing responsibilities for a patient with mania is providing a low-stimulus, structured environment.","options":["True","False"],"answer":"True"},
            {"question":"Persistent Depressive Disorder (PDD) is characterized by depressive symptoms that have lasted for at least two years.","options":["True","False"],"answer":"True"},
            {"question":"Extrapyramidal symptoms are more common with typical antipsychotics.","options":["True","False"],"answer":"True"},
            {"question":"One characteristic of milieu therapy is open communication between staff and clients.","options":["True","False"],"answer":"True"},
            {"question":"Clozapine requires regular monitoring of white blood cell count.","options":["True","False"],"answer":"True"},
            {"question":"A therapeutic milieu provides a safe and non-punitive atmosphere that reduces environmental stress.","options":["True","False"],"answer":"True"},
            {"question":"Disorganized speech is considered a positive symptom of schizophrenia.","options":["True","False"],"answer":"True"},
            {"question":"One disadvantage of milieu therapy is that individual needs may sometimes not be fully met.","options":["True","False"],"answer":"True"},
            {"question":"SSRIs increase serotonin levels by preventing its reuptake in the synaptic cleft.","options":["True","False"],"answer":"True"},
            {"question":"Schizophrenia requires at least one month of active-phase symptoms for diagnosis.","options":["True","False"],"answer":"True"},
            {"question":"Recreational therapy in milieu therapy helps patients express their thoughts and feelings nonverbally.","options":["True","False"],"answer":"True"},
            {"question":"Patients with OCD usually recognize that their thoughts are irrational.","options":["True","False"],"answer":"True"},
            {"question":"Compulsions are performed to neutralize anxiety caused by obsessions.","options":["True","False"],"answer":"True"},
            {"question":"A major precaution for patients using benzodiazepines is to avoid alcohol and other CNS depressants.","options":["True","False"],"answer":"True"},
            {"question":"Schizotypal patients may develop brief psychotic symptoms under stress.","options":["True","False"],"answer":"True"},
            {"question":"Social anxiety disorder can significantly impair social and occupational functioning.","options":["True","False"],"answer":"True"},
            {"question":"Patients with social anxiety disorder are usually afraid of being judged, criticized, or evaluated by others.","options":["True","False"],"answer":"True"},
            {"question":"Normal anxiety is usually short-term and related to a specific stressor.","options":["True","False"],"answer":"True"},
            {"question":"Schizoid personality disorder patients prefer social interaction.","options":["True","False"],"answer":"False"},
            {"question":"Milieu therapy focuses only on individual psychotherapy sessions.","options":["True","False"],"answer":"False"},
            {"question":"Hypomania is a severe form of mania that always requires hospitalization and is often accompanied by psychotic symptoms.","options":["True","False"],"answer":"False"},
            {"question":"All patients who attempt suicide have a diagnosed mental illness.","options":["True","False"],"answer":"False"},
            {"question":"Mania is always less severe than hypomania.","options":["True","False"],"answer":"False"},
            {"question":"Hypomania usually requires hospitalization due to severe functional impairment and psychosis.","options":["True","False"],"answer":"False"},
            {"question":"Tardive dyskinesia is usually reversible immediately after stopping the drug.","options":["True","False"],"answer":"False"},
            {"question":"Occupational therapy in milieu therapy mainly focuses on prescribing medications.","options":["True","False"],"answer":"False"},
            {"question":"Antipsychotic medications are ineffective in treating positive symptoms of schizophrenia.","options":["True","False"],"answer":"False"},
            {"question":"Negative symptoms of schizophrenia include hallucinations and delusions.","options":["True","False"],"answer":"False"},
            {"question":"Electroconvulsive therapy is contraindicated in all elderly patients.","options":["True","False"],"answer":"False"},
            {"question":"Obsessions are repetitive behaviors performed to reduce anxiety.","options":["True","False"],"answer":"False"},
            {"question":"Benzodiazepines are typically used as a long-term treatment for anxiety disorders.","options":["True","False"],"answer":"False"},
            {"question":"Generalized anxiety disorder is characterized by sudden, unexpected panic attacks only.","options":["True","False"],"answer":"False"},
            {"question":"Normal anxiety can last for weeks, months, or years and often requires therapy or medication.","options":["True","False"],"answer":"False"},
            {"question":"Depression can be completely cured with drugs.","options":["True","False"],"answer":"False"},
            {"question":"Which description best fits an anxiety disorder?","options":["A brief normal fear that disappears immediately","Excessive worry and fear that impair daily functioning","A mood state that lasts only minutes","A fixed false belief about reality"],"answer":"Excessive worry and fear that impair daily functioning"},
            {"question":"A patient feels tense before an exam, but the feeling disappears after the exam is over. This is most likely:","options":["Pathological anxiety","Normal anxiety","OCD","Schizophrenia"],"answer":"Normal anxiety"},
            {"question":"Which pair correctly matches the concepts?","options":["Fear = internal trigger, Anxiety = external trigger","Stress = internal trigger, Fear = uncertain outcome","Fear = alerts to danger, Anxiety = worry with uncertain outcome","Anxiety disorder = normal short-lived reaction"],"answer":"Fear = alerts to danger, Anxiety = worry with uncertain outcome"},
            {"question":"Obsessive-compulsive disorder is mainly characterized by:","options":["Hallucinations and delusions","Obsessions and compulsions","Low mood and loss of energy","Social withdrawal and flat affect"],"answer":"Obsessions and compulsions"},
            {"question":"A patient repeatedly checks the door lock because of a disturbing thought that something bad will happen. The repeated checking is a:","options":["Obsession","Compulsion","Delusion","Hallucination"],"answer":"Compulsion"},
            {"question":"Intrusive, unwanted thoughts are called:","options":["Compulsions","Obsessions","Hallucinations","Ideas of reference"],"answer":"Obsessions"},
            {"question":"Which is a common sign of OCD that may interfere with daily life?","options":["Excessive time spent on washing or cleaning","Rapid mood swings only","Mutism","Grandiosity"],"answer":"Excessive time spent on washing or cleaning"},
            {"question":"Panic attacks usually peak within:","options":["Several days","Several hours","Minutes","Weeks"],"answer":"Minutes"},
            {"question":"Depression is best described as:","options":["Short-lived excitement","Persistent sadness or emptiness with loss of interest","Repetitive behaviors that reduce anxiety","False sensory perception"],"answer":"Persistent sadness or emptiness with loss of interest"},
            {"question":"Major depressive disorder requires symptoms for at least:","options":["3 days","1 week","2 weeks","2 years"],"answer":"2 weeks"},
            {"question":"Persistent depressive disorder is defined by symptoms lasting at least:","options":["2 weeks","6 months","1 year","2 years"],"answer":"2 years"},
            {"question":"Which is a cognitive symptom of depression?","options":["Excessive sweating","Impaired concentration","Hallucinations","Tremor"],"answer":"Impaired concentration"},
            {"question":"Which antidepressant class is known to selectively inhibit serotonin reuptake?","options":["TCAs","SSRIs","MAOIs","Beta-blockers"],"answer":"SSRIs"},
            {"question":"Antidepressants usually do not work immediately; mood improvement often appears after:","options":["24 hours","1–2 days","4–6 weeks","1 year"],"answer":"4–6 weeks"},
            {"question":"Early improvement in sleep, appetite, and energy with antidepressants may appear after:","options":["1–2 weeks","4–6 weeks","2–3 months","1 day"],"answer":"1–2 weeks"},
            {"question":"A common SSRI adverse effect is:","options":["Nausea and sexual dysfunction","Hair loss and deafness","Kidney stones","Severe anemia"],"answer":"Nausea and sexual dysfunction"},
            {"question":"Combining SSRIs with MAOIs may lead to:","options":["Serotonin syndrome","Diabetes insipidus","Parkinsonism","Hypothyroidism"],"answer":"Serotonin syndrome"},
            {"question":"Tricyclic antidepressants mainly block reuptake of:","options":["Dopamine only","Serotonin and norepinephrine","GABA and glutamate","Acetylcholine and histamine"],"answer":"Serotonin and norepinephrine"},
            {"question":"Which side effect is more characteristic of TCAs than SSRIs?","options":["Dry mouth and constipation","Diarrhea only","Increased reflexes","Hallucinations"],"answer":"Dry mouth and constipation"},
            {"question":"Benzodiazepines act mainly by:","options":["Blocking dopamine receptors","Binding to the GABA-A receptor complex and enhancing inhibition","Inhibiting serotonin reuptake","Blocking norepinephrine release"],"answer":"Binding to the GABA-A receptor complex and enhancing inhibition"},
            {"question":"Which of the following is a commonly prescribed benzodiazepine?","options":["Haloperidol","Clonazepam","Fluoxetine","Lithium"],"answer":"Clonazepam"},
            {"question":"Beta-blockers are included in the lecture as one of the types of:","options":["Antidepressants","Anti-anxiety medications","Antipsychotics","Mood stabilizers"],"answer":"Anti-anxiety medications"},
            {"question":"Which statement best describes typical antipsychotics?","options":["They are preferred long term because they have fewer motor side effects","They mainly block dopamine D2 receptors and are linked to more EPS","They act mainly on serotonin only","They are ineffective in psychosis"],"answer":"They mainly block dopamine D2 receptors and are linked to more EPS"},
            {"question":"Atypical antipsychotics are generally preferred long term because they:","options":["Cause more extrapyramidal symptoms","Have lower risk of EPS and motor side effects","Do not work on schizophrenia","Only treat anxiety"],"answer":"Have lower risk of EPS and motor side effects"},
            {"question":"Which symptom is a positive symptom of schizophrenia?","options":["Flat affect","Avolition","Delusions","Social withdrawal"],"answer":"Delusions"},
            {"question":"Which symptom is a negative symptom of schizophrenia?","options":["Hallucinations","Disorganized speech","Avolition","Delusions"],"answer":"Avolition"},
            {"question":"A patient who suddenly cannot sit still and keeps pacing after starting an antipsychotic is showing:","options":["Akathisia","Dystonia","Tardive dyskinesia","Parkinsonism"],"answer":"Akathisia"},
            {"question":"Lip smacking and repetitive involuntary movements after long-term antipsychotic use suggest:","options":["Parkinsonism","Tardive dyskinesia","Acute dystonia","Akathisia"],"answer":"Tardive dyskinesia"},
            {"question":"Atypical antipsychotics are effective against:","options":["Positive symptoms only","Negative symptoms only","Both positive and negative symptoms","None of the above"],"answer":"Both positive and negative symptoms"},
            {"question":"Which antipsychotic requires regular white blood cell count monitoring?","options":["Clozapine","Diazepam","Fluoxetine","Sertraline"],"answer":"Clozapine"},
            {"question":"Anxiety disorders may significantly impair daily functioning.","options":["True","False"],"answer":"True"},
            {"question":"Fear is described in the lecture as a natural emotion that alerts us to danger.","options":["True","False"],"answer":"True"},
            {"question":"Obsessions are repetitive behaviors performed to reduce anxiety.","options":["True","False"],"answer":"False"},
            {"question":"Compulsions are repetitive behaviors or mental acts performed in response to obsessions.","options":["True","False"],"answer":"True"},
            {"question":"Depression may include sleep disturbance such as insomnia or hypersomnia.","options":["True","False"],"answer":"True"},
            {"question":"Seasonal affective disorder usually appears during spring and summer.","options":["True","False"],"answer":"False"},
            {"question":"SSRIs can cause sexual dysfunction and gastrointestinal side effects.","options":["True","False"],"answer":"True"},
            {"question":"SSRIs should be stopped abruptly without concern.","options":["True","False"],"answer":"False"},
            {"question":"Serotonin syndrome may present with agitation, diarrhea, myoclonus, and sweating.","options":["True","False"],"answer":"True"},
            {"question":"TCAs can cause anticholinergic effects such as dry mouth and constipation.","options":["True","False"],"answer":"True"},
            {"question":"Benzodiazepines enhance the effect of GABA in the brain.","options":["True","False"],"answer":"True"},
            {"question":"Typical antipsychotics are usually preferred for long-term treatment because they have fewer motor side effects.","options":["True","False"],"answer":"False"},
            {"question":"Schizophrenia commonly emerges in late adolescence or early adulthood.","options":["True","False"],"answer":"True"},
            {"question":"Identical twins have a higher chance of developing schizophrenia if one twin is affected.","options":["True","False"],"answer":"True"},
            {"question":"In schizophrenia, hallucinations are considered a negative symptom.","options":["True","False"],"answer":"False"},
            {"question":"Personality disorders usually begin in the teenage years or early adulthood.","options":["True","False"],"answer":"True"},
            {"question":"Cluster B personality disorders are described as anxious and fearful.","options":["True","False"],"answer":"False"},
            {"question":"Milieu therapy is a type of inpatient therapy used in psychiatric hospitals.","options":["True","False"],"answer":"True"},
            {"question":"ECT involves artificial induction of a grand mal seizure by electrical current applied to the brain.","options":["True","False"],"answer":"True"},
            {"question":"Bilateral ECT is described as more effective but associated with more cognitive dysfunction than unilateral ECT.","options":["True","False"],"answer":"True"}   
        ]       
        },
    "نفسية نظري": {
    ...
    "التمريض القائم ع الأدلة": {
        ...
        "الميد ترم":[
            {"question":"Which of the following is NOT a critical thinking skill?","options":["Analysis","Interpretation","Repeatability","Explanation"],"answer":"Repeatability"},
            {"question":"The source of information that gives direct evidence about people or events is called:","options":["Secondary sources","Primary sources","Tertiary sources","Experimental sources"],"answer":"Primary sources"},
            {"question":"The type of thinking that focuses too much on oneself is:","options":["Egocentric","Drone mentality","Considerate","Altruist"],"answer":"Egocentric"},
            {"question":"To be a continuous learner you must do the following EXCEPT:","options":["Have curiosity","Talk to experts","Attend conferences","Listen to movies"],"answer":"Listen to movies"},
            {"question":"Critical thinkers make ethical decisions for the majority by:","options":["Putting their egos aside","Doing best for individuals only","Avoiding analysis","Looking only at details"],"answer":"Putting their egos aside"},
            {"question":"Which source of evidence is at the top of evidence hierarchy?","options":["Case control studies","Randomized control trials","Systematic reviews and meta-analyses","Case studies"],"answer":"Systematic reviews and meta-analyses"},
            {"question":"Steps of evidence-based practice include:","options":["Assessment only","Appraisal only","Application only","All of the above"],"answer":"All of the above"},
            {"question":"Types of evidence available to nurses include:","options":["Research","Experience","Anecdotal evidence","All of the above"],"answer":"All of the above"},
            {"question":"Clinical decisions based on evidence, expertise, and patient preference is called:","options":["Evidence-based nursing","Evidence-based practice","Research","Clinical judgment"],"answer":"Evidence-based nursing"},
            {"question":"All are benefits of EBP EXCEPT:","options":["Up-to-date practice","Reduce cost","Lack of knowledge","Reduce variation"],"answer":"Lack of knowledge"},
            {"question":"All are organizational barriers to EBP EXCEPT:","options":["Poor culture","Heavy workload","Lack of access","Understanding research"],"answer":"Understanding research"},
            {"question":"PICOT stands for:","options":["Problem intervention comparison outcome task","Problem intervention organization time","Population intervention comparison outcome time","Population interview outcome time"],"answer":"Population intervention comparison outcome time"},
            {"question":"Cochrane database is considered:","options":["General resource","Filtered resource","Unfiltered resource","Basic resource"],"answer":"Filtered resource"},
            {"question":"Critical thinkers must avoid emotionalism.","options":["True","False"],"answer":"True"},
            {"question":"Thinking is a static process.","options":["True","False"],"answer":"False"},
            {"question":"Learners naturally have curiosity.","options":["True","False"],"answer":"True"},
            {"question":"Time pressure may lead to poor decisions.","options":["True","False"],"answer":"True"},
            {"question":"Critical thinkers seek new solutions.","options":["True","False"],"answer":"True"},
            {"question":"Organization is the first source of evidence.","options":["True","False"],"answer":"False"},
            {"question":"Evaluation determines if outcomes are achieved.","options":["True","False"],"answer":"True"},
            {"question":"EBP increases patient satisfaction.","options":["True","False"],"answer":"True"},
            {"question":"Critical thinkers are good communicators.","options":["True","False"],"answer":"True"},
            {"question":"Organizational evidence comes from managers.","options":["True","False"],"answer":"False"},
            {"question":"EBP provides scientific basis for practice.","options":["True","False"],"answer":"True"},
            {"question":"Lack of time is a barrier to EBP.","options":["True","False"],"answer":"True"},
            {"question":"Explanation means investigating based on data.","options":["True","False"],"answer":"False"},
            {"question":"EBP hierarchy does not rank studies.","options":["True","False"],"answer":"False"},
            {"question":"EBP reduces variation in care.","options":["True","False"],"answer":"True"},
            {"question":"EBP applies research to practice.","options":["True","False"],"answer":"True"},
            {"question":"Formulating question is the last step of EBP.","options":["True","False"],"answer":"False"},
            {"question":"Filtered resources summarize evidence.","options":["True","False"],"answer":"True"},
            {"question":"Relevance means accuracy of measurement.","options":["True","False"],"answer":"False"},
            {"question":"Critical thinkers are interested in others' ideas.","options":["True","False"],"answer":"True"},
        ],
        "أسئلة عامة":[
            {"question":"A nurse revises her initial judgment after realizing possible bias. Which skill is this?","options":["Interpretation","Self regulation","Evaluation","Explanation"],"answer":"Self regulation"},
            {"question":"Acting automatically without awareness is best described as:","options":["Egocentric thinking","Drone mentality","Analysis","Flexible thinking"],"answer":"Drone mentality"},
            {"question":"Which is NOT consistent with continuous learning?","options":["Reading updates","Talking to experts","Attending conferences","Listening to movies"],"answer":"Listening to movies"},
            {"question":"Explaining meaning of patient data reflects which skill?","options":["Interpretation","Evaluation","Explanation","Self regulation"],"answer":"Interpretation"},
            {"question":"EBP mainly means:","options":["Only experience","Research + expertise + patient preference","Tradition","Textbooks only"],"answer":"Research + expertise + patient preference"},
            {"question":"Current, valid, relevant research in EBP is:","options":["Patient values","Best external evidence","Routine","Culture"],"answer":"Best external evidence"},
            {"question":"Patient preferences in EBP are part of:","options":["Research","Expertise","Patient values","Guidelines"],"answer":"Patient values"},
            {"question":"Which is a filtered resource?","options":["PubMed","Scopus","Cochrane","Web of Science"],"answer":"Cochrane"},
            {"question":"Which gives original studies?","options":["Textbook","Guideline","PubMed","Systematic review"],"answer":"PubMed"},
            {"question":"O in PICOT means:","options":["Opportunity","Observation","Outcome","Organization"],"answer":"Outcome"},
            {"question":"Patient consequence belongs to:","options":["P","I","C","O"],"answer":"O"},
            {"question":"First step in EBP:","options":["Apply","Ask","Appraise","Assess"],"answer":"Ask"},
            {"question":"Collecting studies step is:","options":["Acquire","Apply","Assess","Allow"],"answer":"Acquire"},
            {"question":"Judging validity is:","options":["Sharing","Appraisal","Writing","Choosing topic"],"answer":"Appraisal"},
            {"question":"Combining many studies is:","options":["Case report","Cohort","Systematic review","Opinion"],"answer":"Systematic review"},
            {"question":"Highest evidence level:","options":["Case study","Case control","RCT","Systematic review"],"answer":"Systematic review"},
            {"question":"Making guidelines known is:","options":["Construction","Dissemination","Validation","Translation"],"answer":"Dissemination"},
            {"question":"Making staff follow guidelines is:","options":["Review","Implementation","Dissemination","Search"],"answer":"Implementation"},
            {"question":"Same result when repeated is:","options":["Flexibility","Reliability","Clear","Applicable"],"answer":"Reliability"},
            {"question":"Updating guideline regularly is:","options":["Systemic review","Flexibility","Validity","Clear"],"answer":"Systemic review"},
            {"question":"PET model is:","options":["Iowa","Stetler","Johns Hopkins","Rosswurm"],"answer":"Johns Hopkins"},
            {"question":"Trigger → problem → pilot is:","options":["Iowa","Censo","Stetler","Johns"],"answer":"Iowa"},
            {"question":"Model focusing on patient preference:","options":["Stetler","Censo","Rosswurm","Johns"],"answer":"Censo"},
            {"question":"Model starting with stakeholder needs:","options":["Rosswurm","Censo","Iowa","Stetler"],"answer":"Rosswurm"},

            {"question":"Thinking is a dynamic process.","options":["True","False"],"answer":"True"},
            {"question":"Critical thinkers depend on emotions.","options":["True","False"],"answer":"False"},
            {"question":"Critical thinkers accept others’ ideas.","options":["True","False"],"answer":"True"},
            {"question":"Time pressure never affects decisions.","options":["True","False"],"answer":"False"},
            {"question":"EBP reduces variation in care.","options":["True","False"],"answer":"True"},
            {"question":"EBP ignores clinical expertise.","options":["True","False"],"answer":"False"},
            {"question":"Lack of skills is a barrier to EBP.","options":["True","False"],"answer":"True"},
            {"question":"Heavy workload is not a barrier.","options":["True","False"],"answer":"False"},
            {"question":"PubMed is a filtered resource.","options":["True","False"],"answer":"False"},
            {"question":"Filtered resources summarize evidence.","options":["True","False"],"answer":"True"},
            {"question":"Guidelines should be rigid.","options":["True","False"],"answer":"False"},
            {"question":"Dissemination means applying guidelines.","options":["True","False"],"answer":"False"},
            {"question":"Implementation is active process.","options":["True","False"],"answer":"True"},
            {"question":"Validity predicts outcomes.","options":["True","False"],"answer":"True"},
            {"question":"Stetler model has 5 steps.","options":["True","False"],"answer":"True"},
            {"question":"A nurse compares multiple studies before choosing the best-supported conclusion. Which skill is used?","options":["Interpretation","Evaluation","Explanation","Self-regulation"],"answer":"Evaluation"},
            {"question":"Checking credibility and reliability of evidence reflects:","options":["Principles of critical thinking","Barriers","Types only","Social conditioning"],"answer":"Principles of critical thinking"},
            {"question":"Analysis paralysis is best described as:","options":["Ignoring evidence","Unable to decide due to over-analysis","Accepting first answer","Following guideline"],"answer":"Unable to decide due to over-analysis"},
            {"question":"Which is a filtered resource?","options":["PubMed","Scopus","Cochrane","Web of Science"],"answer":"Cochrane"},
            {"question":"Best source for original studies:","options":["Guideline","PubMed","Textbook","Cochrane"],"answer":"PubMed"},
            {"question":"In PICOT, 'elderly hypertensive patients' is:","options":["I","O","P","T"],"answer":"P"},
            {"question":"In PICOT, 'salt restriction' is:","options":["P","I","C","O"],"answer":"I"},
            {"question":"After finding evidence, next step is:","options":["Apply","Appraise","Disseminate","Convert"],"answer":"Appraise"},
            {"question":"Appraisal focuses on:","options":["Appearance","Validity and relevance","Publication","Agreement"],"answer":"Validity and relevance"},
            {"question":"Experience-based decision reflects:","options":["External evidence","Clinical expertise","Filtered evidence","Meta-analysis"],"answer":"Clinical expertise"},
            {"question":"Top level of evidence:","options":["Case report","Case control","RCT","Systematic review"],"answer":"Systematic review"},
            {"question":"Single patient detailed report is:","options":["Cohort","Case report","RCT","Meta-analysis"],"answer":"Case report"},
            {"question":"Organizational barrier example:","options":["Lack knowledge","Time","Heavy workload","Understanding research"],"answer":"Heavy workload"},
            {"question":"Research-related barrier:","options":["No access","Language difficulty","No support","No time"],"answer":"Language difficulty"},
            {"question":"Dissemination example:","options":["Force staff","Publish guideline","Remove barriers","Monitor"],"answer":"Publish guideline"},
            {"question":"Consistency across professionals is:","options":["Flexibility","Reliability","Clear","Applicable"],"answer":"Reliability"},
            {"question":"Adaptability of guideline is:","options":["Flexibility","Validity","Systemic review","Limited"],"answer":"Flexibility"},
            {"question":"PET model belongs to:","options":["Iowa","Stetler","Johns Hopkins","Rosswurm"],"answer":"Johns Hopkins"},
            {"question":"Trigger → pilot model:","options":["Censo","Iowa","Stetler","Johns"],"answer":"Iowa"},
            {"question":"Model focusing on patient preference:","options":["Stetler","Censo","Iowa","Rosswurm"],"answer":"Censo"},

            {"question":"Interpretation equals evaluation of study validity.","options":["True","False"],"answer":"False"},
            {"question":"Self-regulation includes correcting bias.","options":["True","False"],"answer":"True"},
            {"question":"Thinking is dynamic.","options":["True","False"],"answer":"True"},
            {"question":"Critical thinkers question evidence sources.","options":["True","False"],"answer":"True"},
            {"question":"EBP depends only on research.","options":["True","False"],"answer":"False"},
            {"question":"Evidence hierarchy ranks strength of studies.","options":["True","False"],"answer":"True"},
            {"question":"Unfiltered resources summarize evidence.","options":["True","False"],"answer":"False"},
            {"question":"EBP reduces variation in care.","options":["True","False"],"answer":"True"},
            {"question":"Lack of database access is nurse-related barrier.","options":["True","False"],"answer":"False"},
            {"question":"Guidelines are based on synthesized evidence.","options":["True","False"],"answer":"True"},
            {"question":"Dissemination ensures action.","options":["True","False"],"answer":"False"},
            {"question":"Implementation focuses on behavior change.","options":["True","False"],"answer":"True"},
            {"question":"Validity predicts outcomes.","options":["True","False"],"answer":"True"},
            {"question":"Stetler model has five steps.","options":["True","False"],"answer":"True"},
            {"question":"Rosswurm model is based on theory and research.","options":["True","False"],"answer":"True"},
        ],
    },
    "علوم الحاسب":{
    ...
    "طب نسا":{
        "ANC":[
            {"question":"The main purpose of antenatal care is to detect pregnancy abnormalities early, correct them, and teach healthy pregnancy habits.","options":["True","False"],"answer":"True"},
            {"question":"Screening in antenatal care aims to identify high-risk pregnancies early and refer them for specialized care.","options":["True","False"],"answer":"True"},
            {"question":"The appropriate schedule for low-risk pregnancy is weekly throughout the entire pregnancy.","options":["True","False"],"answer":"False"},
            {"question":"High-risk pregnancy follow-up includes hospitalization from 36 weeks until delivery.","options":["True","False"],"answer":"True"},
            {"question":"The booking visit includes only blood pressure and weight measurement.","options":["True","False"],"answer":"False"},
            {"question":"Urine analysis for proteins and glucose is part of routine ANC investigations.","options":["True","False"],"answer":"True"},
            {"question":"Hepatitis B surface antigen is considered a routine test in all cases.","options":["True","False"],"answer":"False"},
            {"question":"At every ANC visit, weight gain, blood pressure, fundal height, and fetal heart rate should be checked.","options":["True","False"],"answer":"True"},
            {"question":"Smoking during pregnancy has no effect on fetal growth.","options":["True","False"],"answer":"False"},
            {"question":"Sexual intercourse is discouraged in late pregnancy to avoid PROM.","options":["True","False"],"answer":"True"},
            {"question":"Blurred vision and headache are minor symptoms that do not need attention.","options":["True","False"],"answer":"False"},
            {"question":"Recommended caloric intake in pregnancy is about 2400 kcal/day.","options":["True","False"],"answer":"True"},
            {"question":"Protein intake should be decreased during pregnancy.","options":["True","False"],"answer":"False"},
            {"question":"Total iron requirement during pregnancy is about 1 gram.","options":["True","False"],"answer":"True"},
            {"question":"Pregnant women need only 5 mg iron daily.","options":["True","False"],"answer":"False"},
            {"question":"Iron supplementation is more important in the second half of pregnancy.","options":["True","False"],"answer":"True"},
            {"question":"Zinc deficiency has no relation to PROM.","options":["True","False"],"answer":"False"},
            {"question":"Iodine deficiency can lead to cretinism.","options":["True","False"],"answer":"True"},
            {"question":"Fluoride deficiency is unrelated to dental caries.","options":["True","False"],"answer":"False"},
            {"question":"Folic acid deficiency may cause neural tube defects.","options":["True","False"],"answer":"True"},
            {"question":"Vitamin D deficiency may lead to osteomalacia.","options":["True","False"],"answer":"True"},
            {"question":"Johnson’s formula uses fundal height to estimate fetal weight.","options":["True","False"],"answer":"True"},
            {"question":"Gush of fluid is a normal sign in pregnancy.","options":["True","False"],"answer":"False"},
            {"question":"A high-risk pregnancy requires more frequent follow-up than low-risk pregnancy.","options":["True","False"],"answer":"True"},
            {"question":"Antenatal care focuses only on treatment not prevention.","options":["True","False"],"answer":"False"},
            {"question":"Screening helps classify pregnancies into high-risk and low-risk.","options":["True","False"],"answer":"True"},
            {"question":"Hospitalization is never needed in pregnancy.","options":["True","False"],"answer":"False"},
            {"question":"Urine analysis can detect infection in pregnancy.","options":["True","False"],"answer":"True"},
            {"question":"Protein intake should be increased during pregnancy.","options":["True","False"],"answer":"True"},
            {"question":"Iron supplementation may cause gastrointestinal side effects.","options":["True","False"],"answer":"True"},
            {"question":"Carbohydrate intake in pregnancy is about 300 gm/day.","options":["True","False"],"answer":"True"},
            {"question":"Weekly visits are required in the last month of pregnancy.","options":["True","False"],"answer":"True"},
            {"question":"Toxoplasmosis test is always mandatory routine investigation.","options":["True","False"],"answer":"False"},
            {"question":"Selenium plays a role in antioxidant protection.","options":["True","False"],"answer":"True"},
            {"question":"Estimated fetal weight does not depend on fundal height.","options":["True","False"],"answer":"False"},
            {"question":"Vitamin D requirement is about 600 IU/day.","options":["True","False"],"answer":"True"},
            {"question":"Vaginal examination is done at every visit routinely.","options":["True","False"],"answer":"False"},
            {"question":"Iron is transported mainly by transferrin.","options":["True","False"],"answer":"True"},
            {"question":"Vitamin C helps prevent postpartum hemorrhage.","options":["True","False"],"answer":"True"},
            {"question":"Chromium has no role in insulin function.","options":["True","False"],"answer":"False"},
            {"question":"Daily calcium requirement is about 1.2 gm.","options":["True","False"],"answer":"True"},
            {"question":"Pregnant women should sleep less than 5 hours.","options":["True","False"],"answer":"False"},
            {"question":"Fluid intake helps prevent constipation.","options":["True","False"],"answer":"True"},
            {"question":"Vitamin B deficiency may cause beri beri.","options":["True","False"],"answer":"True"},
            {"question":"Iron need in pregnancy is less than in non-pregnant state.","options":["True","False"],"answer":"False"},
            {"question":"High heels are recommended during pregnancy.","options":["True","False"],"answer":"False"},
            {"question":"Cervical culture is routinely done at every ANC visit.","options":["True","False"],"answer":"False"},
            {"question":"Intercourse in early pregnancy may increase risk of abortion.","options":["True","False"],"answer":"True"}

        ],
        "Contraception":[
            {"question":"Contraception is defined as prevention of menstruation at will.","options":["True","False"],"answer":"False"},
            {"question":"Lactation is considered a physiological contraceptive method.","options":["True","False"],"answer":"True"},
            {"question":"Lactational contraception works mainly through decreased prolactin leading to increased gonadotropins.","options":["True","False"],"answer":"False"},
            {"question":"Frequent breastfeeding including night feeds improves the effectiveness of lactational contraception.","options":["True","False"],"answer":"True"},
            {"question":"In the calendar method, the first fertile day is calculated as the shortest cycle minus 18 days.","options":["True","False"],"answer":"False"},
            {"question":"In the calendar method, the last fertile day is calculated as the longest cycle minus 10 days.","options":["True","False"],"answer":"True"},
            {"question":"For a 28-day cycle, the fertile period is approximately between days 8–18.","options":["True","False"],"answer":"True"},
            {"question":"Basal body temperature rises due to the thermogenic effect of estrogen.","options":["True","False"],"answer":"False"},
            {"question":"Fertility continues until 3 consecutive days after the temperature rise in the BBT method.","options":["True","False"],"answer":"True"},
            {"question":"Cervical mucus becomes thick and dry around ovulation.","options":["True","False"],"answer":"False"},
            {"question":"Coitus interruptus has a high failure rate due to possible sperm in pre-ejaculatory fluid.","options":["True","False"],"answer":"True"},
            {"question":"Male condoms do not protect against sexually transmitted diseases.","options":["True","False"],"answer":"False"},
            {"question":"Male condoms should be applied after ejaculation.","options":["True","False"],"answer":"False"},
            {"question":"Vaseline increases the tensile strength of condoms.","options":["True","False"],"answer":"False"},
            {"question":"The diaphragm is a barrier method used in the female genital tract.","options":["True","False"],"answer":"True"},
            {"question":"Diaphragm retention may lead to toxic shock syndrome.","options":["True","False"],"answer":"True"},
            {"question":"The vaginal sponge contains Nonoxynol-9 as a spermicidal agent.","options":["True","False"],"answer":"True"},
            {"question":"The female condom is a polyurethane sheath with two rings that covers the vagina and vulva.","options":["True","False"],"answer":"True"},
            {"question":"Female condom cannot be used in dyspareunia.","options":["True","False"],"answer":"False"},
            {"question":"Spermicides used alone have a very low failure rate.","options":["True","False"],"answer":"False"},
            {"question":"Spermicides are best used as an adjuvant with other contraceptive methods.","options":["True","False"],"answer":"True"},
            {"question":"Lippes loop is a medicated IUCD.","options":["True","False"],"answer":"False"},
            {"question":"Copper in IUCD decreases contraceptive effectiveness.","options":["True","False"],"answer":"False"},
            {"question":"IUCD works partly by causing a sterile inflammatory reaction in the uterus.","options":["True","False"],"answer":"True"},
            {"question":"Known or suspected pregnancy is not a contraindication to IUCD use.","options":["True","False"],"answer":"False"},
            {"question":"Postmenstrual IUCD insertion is preferred because pregnancy can be excluded and the cervix is more patulous.","options":["True","False"],"answer":"True"},
            {"question":"After IUCD insertion, no follow-up is required.","options":["True","False"],"answer":"False"},
            {"question":"Bleeding is a common IUCD complication.","options":["True","False"],"answer":"True"},
            {"question":"IUCD-related pain should not be treated.","options":["True","False"],"answer":"False"},
            {"question":"Inability to feel IUCD strings may indicate a missed loop.","options":["True","False"],"answer":"True"},
            {"question":"Estrogen-containing contraceptives suppress ovulation by inhibiting the H-P-O axis.","options":["True","False"],"answer":"True"},
            {"question":"Progestin in contraceptives acts centrally only.","options":["True","False"],"answer":"False"},
            {"question":"Progestin thickens cervical mucus and blocks sperm penetration.","options":["True","False"],"answer":"True"},
            {"question":"Nausea and vomiting are unrelated to estrogen in pills.","options":["True","False"],"answer":"False"},
            {"question":"History of thromboembolic disease is an absolute contraindication to steroid contraception.","options":["True","False"],"answer":"True"},
            {"question":"Combined oral contraceptives cannot be used for dysfunctional uterine bleeding.","options":["True","False"],"answer":"False"},
            {"question":"DMPA is a long-acting injectable progestin contraceptive.","options":["True","False"],"answer":"True"},
            {"question":"Pellets are biodegradable subdermal implants.","options":["True","False"],"answer":"True"},
            {"question":"Injectable progestins have a high failure rate.","options":["True","False"],"answer":"False"},
            {"question":"Tubal ligation is one of the most effective contraceptive methods.","options":["True","False"],"answer":"True"},
            {"question":"Mifepristone cannot be used as post-coital contraception.","options":["True","False"],"answer":"False"},
            {"question":"Safe period and male condom are suitable methods for newly married couples.","options":["True","False"],"answer":"True"},
            {"question":"IUCD or progestin-only pills are preferred during lactation.","options":["True","False"],"answer":"True"},
            {"question":"Safe period depends on using drugs to suppress ovulation.","options":["True","False"],"answer":"False"},
            {"question":"Spermicides cannot be used after condom rupture.","options":["True","False"],"answer":"False"},
            {"question":"Oil-based lubricants weaken condoms.","options":["True","False"],"answer":"True"},
            {"question":"IUCD works by suppressing ovulation.","options":["True","False"],"answer":"False"},
            {"question":"Pulling IUCD strings regularly is recommended.","options":["True","False"],"answer":"False"},
            {"question":"IUCD complications include bleeding, pain, infection, and missed loop.","options":["True","False"],"answer":"True"},
            {"question":"Progestin-only pills are suitable during lactation.","options":["True","False"],"answer":"True"},
            {"question":"Norplant is a biodegradable implant.","options":["True","False"],"answer":"False"},
            {"question":"Combined pills are preferred in cardiac patients.","options":["True","False"],"answer":"False"},
            {"question":"Women above 35 years cannot use IUCD.","options":["True","False"],"answer":"False"},
            {"question":"Gynefix IUCD reduces expulsion and bleeding.","options":["True","False"],"answer":"True"},
            {"question":"GnRH analogues are used in endometriosis and fibroids.","options":["True","False"],"answer":"True"}

        ],
        "Dysmenorrhea":[
            {"question":"Dysmenorrhea is defined as painful menstruation that may begin just before or during the period.","options":["True","False"],"answer":"True"},
            {"question":"Primary dysmenorrhea occurs due to evident pelvic pathology.","options":["True","False"],"answer":"False"},
            {"question":"Primary dysmenorrhea is most common in multiparous women.","options":["True","False"],"answer":"False"},
            {"question":"Primary dysmenorrhea typically presents as colicky suprapubic pain starting on the first day of menstruation.","options":["True","False"],"answer":"True"},
            {"question":"Primary dysmenorrhea is mainly caused by decreased prostaglandins.","options":["True","False"],"answer":"False"},
            {"question":"Nausea and vomiting in primary dysmenorrhea are related to increased prostaglandins.","options":["True","False"],"answer":"True"},
            {"question":"Congenital uterine anomalies such as bicornuate uterus may contribute to primary dysmenorrhea.","options":["True","False"],"answer":"True"},
            {"question":"A normal pelvic examination with colicky menstrual pain suggests primary dysmenorrhea.","options":["True","False"],"answer":"True"},
            {"question":"Teaching menstrual physiology and hygiene is part of management of primary dysmenorrhea.","options":["True","False"],"answer":"True"},
            {"question":"Antiprostaglandins such as mefenamic acid are used to treat dysmenorrhea pain.","options":["True","False"],"answer":"True"},
            {"question":"Beta-blockers are the main antispasmodics used in dysmenorrhea.","options":["True","False"],"answer":"False"},
            {"question":"Oral contraceptive pills may be used in primary dysmenorrhea to suppress ovulation.","options":["True","False"],"answer":"True"},
            {"question":"Cervical dilatation is useful in dysmenorrhea caused by cervical stenosis.","options":["True","False"],"answer":"True"},
            {"question":"LUNA stands for laparoscopic uterine nerve ablation.","options":["True","False"],"answer":"True"},
            {"question":"Congestive dysmenorrhea presents as pain starting after menstruation ends.","options":["True","False"],"answer":"False"},
            {"question":"Congestive dysmenorrhea is more common in parous women.","options":["True","False"],"answer":"True"},
            {"question":"Congestive dysmenorrhea is usually not associated with nausea and vomiting.","options":["True","False"],"answer":"True"},
            {"question":"Pelvic congestion and coitus interruptus may contribute to congestive dysmenorrhea.","options":["True","False"],"answer":"True"},
            {"question":"Endometriosis may cause congestive dysmenorrhea with grinding pain away from midline.","options":["True","False"],"answer":"True"},
            {"question":"Treatment of congestive dysmenorrhea focuses only on analgesics.","options":["True","False"],"answer":"False"},
            {"question":"Glycerine ichthyol pessary may help reduce pelvic congestion.","options":["True","False"],"answer":"True"},
            {"question":"Membranous dysmenorrhea is a form of ovulatory pain.","options":["True","False"],"answer":"False"},
            {"question":"Membranous dysmenorrhea may present with passage of membranous casts.","options":["True","False"],"answer":"True"},
            {"question":"Ovarian dysmenorrhea pain can be reproduced by pressure on the ovary.","options":["True","False"],"answer":"True"},
            {"question":"Ovarian dysmenorrhea is always midline.","options":["True","False"],"answer":"False"},
            {"question":"Mittelschmerz occurs mid-cycle and lasts about 12 hours.","options":["True","False"],"answer":"True"},
            {"question":"PTS symptoms occur randomly throughout the cycle.","options":["True","False"],"answer":"False"},
            {"question":"Increased estrogen causing fluid retention is one theory of PTS.","options":["True","False"],"answer":"True"},
            {"question":"PTS may involve decreased dopamine and increased prolactin.","options":["True","False"],"answer":"True"},
            {"question":"Vitamin A and B6 deficiency may be associated with PTS.","options":["True","False"],"answer":"True"},
            {"question":"Breast tenderness is a common symptom of PTS.","options":["True","False"],"answer":"True"},
            {"question":"Bromocriptine may be used in treatment of PTS.","options":["True","False"],"answer":"True"},
            {"question":"Spironolactone reduces aldosterone and helps in PTS.","options":["True","False"],"answer":"True"},
            {"question":"Exercise like yoga is recommended in PTS.","options":["True","False"],"answer":"True"},
            {"question":"High-fat diet is recommended in PTS.","options":["True","False"],"answer":"False"},
            {"question":"Primary dysmenorrhea is associated with pelvic disease.","options":["True","False"],"answer":"False"},
            {"question":"Congestive dysmenorrhea is associated with severe nausea and vomiting.","options":["True","False"],"answer":"False"},
            {"question":"Membranous dysmenorrhea is common and mild.","options":["True","False"],"answer":"False"},
            {"question":"PTS is mainly due to organic pelvic disease.","options":["True","False"],"answer":"False"},
            {"question":"Increasing caffeine and smoking improves PTS symptoms.","options":["True","False"],"answer":"False"}

        ],
        "Endometriosis":[
            {"question":"Endometriosis is defined as the presence of functional endometrial tissue in abnormal sites.","options":["True","False"],"answer":"True"},
            {"question":"Adenomyosis is endometriosis involving the uterine muscle.","options":["True","False"],"answer":"True"},
            {"question":"The ovary is the most common site of pelvic endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"A laparotomy scar is considered an extra-pelvic site of endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Sampson’s theory explains endometriosis by anterograde menstruation.","options":["True","False"],"answer":"False"},
            {"question":"Meyer’s theory states that only ovarian tissue can become endometrial tissue.","options":["True","False"],"answer":"False"},
            {"question":"Having a first-degree relative with endometriosis increases the risk significantly.","options":["True","False"],"answer":"True"},
            {"question":"Monozygotic twins show no concordance in endometriosis.","options":["True","False"],"answer":"False"},
            {"question":"Endometriosis is associated with autoimmune diseases such as SLE.","options":["True","False"],"answer":"True"},
            {"question":"Cervical stenosis may predispose to endometriosis by promoting retrograde menstruation.","options":["True","False"],"answer":"True"},
            {"question":"Procedures like D&C or HSG during menstruation may predispose to endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Ovarian endometriosis typically appears as a chocolate cyst.","options":["True","False"],"answer":"True"},
            {"question":"Microscopically, endometriosis shows only fibrous tissue without glands.","options":["True","False"],"answer":"False"},
            {"question":"Pelvic endometriosis may appear as small dark spots with adhesions.","options":["True","False"],"answer":"True"},
            {"question":"Frozen pelvis refers to a freely mobile uterus.","options":["True","False"],"answer":"False"},
            {"question":"Pain is the main complaint in symptomatic pelvic endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Dysmenorrhea in endometriosis starts after menstruation ends.","options":["True","False"],"answer":"False"},
            {"question":"Endometriosis pain is typically grinding and away from the midline.","options":["True","False"],"answer":"True"},
            {"question":"Menuria refers to cyclic hematuria due to bladder involvement.","options":["True","False"],"answer":"True"},
            {"question":"Endometriosis affecting the bowel may lead to intestinal obstruction.","options":["True","False"],"answer":"True"},
            {"question":"Laparoscopy is the primary tool for diagnosis and management of endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Severe endometriosis may obliterate the Douglas pouch.","options":["True","False"],"answer":"True"},
            {"question":"CA-125 is completely specific for endometriosis.","options":["True","False"],"answer":"False"},
            {"question":"CA-125 can be used to monitor treatment and recurrence.","options":["True","False"],"answer":"True"},
            {"question":"Pregnancy may improve endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Expectant management is unsuitable for mild cases desiring pregnancy.","options":["True","False"],"answer":"False"},
            {"question":"Hormonal therapy is used in symptomatic cases with minimal lesions.","options":["True","False"],"answer":"True"},
            {"question":"Danazol increases estrogen production.","options":["True","False"],"answer":"False"},
            {"question":"Virilization and acne are side effects of danazol.","options":["True","False"],"answer":"True"},
            {"question":"Gestrinone has shorter half-life than danazol.","options":["True","False"],"answer":"False"},
            {"question":"GnRH analogues may cause osteoporosis.","options":["True","False"],"answer":"True"},
            {"question":"Add-back therapy reduces bone loss with GnRH analogues.","options":["True","False"],"answer":"True"},
            {"question":"Conservative surgery is preferred in women desiring fertility.","options":["True","False"],"answer":"True"},
            {"question":"Ovarian cystectomy is used for ovarian endometrioma.","options":["True","False"],"answer":"True"},
            {"question":"Adenomyosis is presence of endometrial tissue within uterine muscle.","options":["True","False"],"answer":"True"},
            {"question":"Adenomyosis is common in young nulliparous women.","options":["True","False"],"answer":"False"},
            {"question":"Ultrasound and MRI can help diagnose adenomyosis.","options":["True","False"],"answer":"True"},
            {"question":"Hysterectomy is a definitive treatment for adenomyosis.","options":["True","False"],"answer":"True"},
            {"question":"A fixed retroverted uterus suggests pelvic endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"A bulky symmetrical uterus suggests adenomyosis.","options":["True","False"],"answer":"True"},
            {"question":"Localized adenomyosis has a well-defined capsule like fibroids.","options":["True","False"],"answer":"False"},
            {"question":"Hormonal therapy is always curative in adenomyosis.","options":["True","False"],"answer":"False"},
            {"question":"Endometriosis has no relation to autoimmune disease.","options":["True","False"],"answer":"False"},
            {"question":"Infertility is a common manifestation of endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Endometriosis adhesions may fix the uterus.","options":["True","False"],"answer":"True"},
            {"question":"Menuria means rectal bleeding during menstruation.","options":["True","False"],"answer":"False"},
            {"question":"Adenomyosis mainly affects older multiparous women.","options":["True","False"],"answer":"True"},
            {"question":"Adenomyosis is diagnosed mainly by laparoscopy.","options":["True","False"],"answer":"False"}

        ],
        "Infertility":[
            {"question":"Infertility is defined as inability to conceive after one year of continuous marital life with regular intercourse and no contraception.","options":["True","False"],"answer":"True"},
            {"question":"Sterility means inability to conceive, while infertility may include inability to produce a viable offspring.","options":["True","False"],"answer":"True"},
            {"question":"One year is used in infertility definition because fecundability over that period is low.","options":["True","False"],"answer":"False"},
            {"question":"The probability of conception after one menstrual cycle is about 20-25%.","options":["True","False"],"answer":"True"},
            {"question":"Primary infertility means the woman has previously conceived.","options":["True","False"],"answer":"False"},
            {"question":"Secondary infertility refers to infertility after a previous conception even if it ended in abortion or ectopic pregnancy.","options":["True","False"],"answer":"True"},
            {"question":"Regular intercourse 3-4 times per week around ovulation improves chances of conception.","options":["True","False"],"answer":"True"},
            {"question":"Male factor is the most common single cause of infertility.","options":["True","False"],"answer":"False"},
            {"question":"Male factor accounts for about 30% of infertility cases.","options":["True","False"],"answer":"True"},
            {"question":"Varicocele may impair fertility by affecting testicular temperature and function.","options":["True","False"],"answer":"True"},
            {"question":"Gonorrhea and chlamydia are causes of bilateral vas obstruction.","options":["True","False"],"answer":"True"},
            {"question":"Myxoedema is a cause of failure of semen deposition in the posterior fornix.","options":["True","False"],"answer":"False"},
            {"question":"Hypospadias causes infertility mainly due to improper semen deposition.","options":["True","False"],"answer":"True"},
            {"question":"Ovarian factor accounts for about 15-20% of infertility cases.","options":["True","False"],"answer":"True"},
            {"question":"Tubal infertility is commonly caused by infections such as chlamydia and gonorrhea.","options":["True","False"],"answer":"True"},
            {"question":"Asherman syndrome is a uterine cause of infertility following intrauterine trauma.","options":["True","False"],"answer":"True"},
            {"question":"Cervical sperm antibodies represent an immunological cause of infertility.","options":["True","False"],"answer":"True"},
            {"question":"Diabetes mellitus can cause infertility by enhancing ovulation.","options":["True","False"],"answer":"False"},
            {"question":"Effluvium seminis is a form of disturbed sexual life affecting fertility.","options":["True","False"],"answer":"True"},
            {"question":"The first step in infertility investigation is complete history and examination of both partners.","options":["True","False"],"answer":"True"},
            {"question":"Dental history is an essential part of infertility evaluation.","options":["True","False"],"answer":"False"},
            {"question":"History of previous marriage and children is important in male infertility assessment.","options":["True","False"],"answer":"True"},
            {"question":"Semen analysis should be performed after 2-3 days of abstinence.","options":["True","False"],"answer":"True"},
            {"question":"Semen analysis should be repeated twice about 2 months apart.","options":["True","False"],"answer":"True"},
            {"question":"Normal semen volume ranges from 2-6 ml.","options":["True","False"],"answer":"True"},
            {"question":"Normal sperm concentration is about 20-60 million/ml.","options":["True","False"],"answer":"True"},
            {"question":"Normal sperm motility is less than 20% at 2 hours.","options":["True","False"],"answer":"False"},
            {"question":"Teratospermia refers to increased abnormal sperm forms.","options":["True","False"],"answer":"True"},
            {"question":"Fructose reflects seminal vesicle function.","options":["True","False"],"answer":"True"},
            {"question":"Acid phosphatase reflects prostate function.","options":["True","False"],"answer":"True"},
            {"question":"Sperm agglutination suggests infection or immunological problems.","options":["True","False"],"answer":"True"},
            {"question":"Testicular biopsy helps differentiate between testicular failure and vas obstruction in azoospermia.","options":["True","False"],"answer":"True"},
            {"question":"Retrograde ejaculation can be diagnosed by urine analysis after ejaculation.","options":["True","False"],"answer":"True"},
            {"question":"Mid-cycle pain is a sign suggestive of ovulation.","options":["True","False"],"answer":"True"},
            {"question":"A normal BBT chart shows a monophasic pattern after ovulation.","options":["True","False"],"answer":"False"},
            {"question":"Serum progesterone 2-10 ng/mL suggests luteal phase defect.","options":["True","False"],"answer":"True"},
            {"question":"Premenstrual endometrial biopsy helps detect ovulation and luteal phase defect.","options":["True","False"],"answer":"True"},
            {"question":"Disappearance of a mature follicle on ultrasound indicates ovulation.","options":["True","False"],"answer":"True"},
            {"question":"Rubin’s test assesses tubal patency using CO2.","options":["True","False"],"answer":"True"},
            {"question":"CO2 is preferred in Rubin’s test because it avoids air embolism and is rapidly excreted.","options":["True","False"],"answer":"True"},
            {"question":"Rubin’s test is best performed during menstruation.","options":["True","False"],"answer":"False"},
            {"question":"Absence of peritoneal spill indicates tubal patency.","options":["True","False"],"answer":"False"},
            {"question":"HSG provides information about uterine cavity abnormalities and tubal obstruction.","options":["True","False"],"answer":"True"},
            {"question":"Oily contrast media in HSG carries higher risk of granuloma and embolism.","options":["True","False"],"answer":"True"},
            {"question":"Chromotubation uses methylene blue dye during laparoscopy.","options":["True","False"],"answer":"True"},
            {"question":"Cervical mucus suitable for sperm penetration is thin, clear, alkaline, and shows ferning.","options":["True","False"],"answer":"True"},
            {"question":"Living sperms in vaginal drop but dead sperms in cervical mucus indicate hostile cervical mucus.","options":["True","False"],"answer":"True"},
            {"question":"A Sim’s Huhner PCT score of 0 means no sperm seen per HPF.","options":["True","False"],"answer":"True"},
            {"question":"SCMC test is used when postcoital test is negative to assess sperm-mucus interaction.","options":["True","False"],"answer":"True"},
            {"question":"Anemia is considered a general factor contributing to infertility.","options":["True","False"],"answer":"True"},
            {"question":"Primary infertility means the woman has conceived before.","options":["True","False"],"answer":"False"},
            {"question":"Male factor infertility accounts for about 70% of cases.","options":["True","False"],"answer":"False"},
            {"question":"Retrograde ejaculation refers to semen entering the bladder instead of exiting through urethra.","options":["True","False"],"answer":"True"},
            {"question":"Hypospadias is an abnormal urethral opening on the ventral side of the penis.","options":["True","False"],"answer":"True"},
            {"question":"Asherman syndrome is a cervical cause of infertility.","options":["True","False"],"answer":"False"},
            {"question":"Vaginismus is a reflex spasm of pelvic muscles during intercourse.","options":["True","False"],"answer":"True"},
            {"question":"Unexplained infertility means no cause is found after evaluation.","options":["True","False"],"answer":"True"},
            {"question":"Azoospermia means absence of sperm in semen.","options":["True","False"],"answer":"True"},
            {"question":"Pus cells more than 5 per HPF in semen are considered normal.","options":["True","False"],"answer":"False"},
            {"question":"Rubin’s test uses air instead of CO2.","options":["True","False"],"answer":"False"},
            {"question":"Cervical mucus suitable for sperm is thick and acidic.","options":["True","False"],"answer":"False"},
            {"question":"A normal postcoital test shows living sperms in both vaginal and cervical samples.","options":["True","False"],"answer":"True"},
            {"question":"Cervical sperm antibodies can cause infertility.","options":["True","False"],"answer":"True"},
            {"question":"Diabetes mellitus and myxoedema may inhibit ovulation and cause infertility.","options":["True","False"],"answer":"True"}

        ],
        "Polycystic Ovary Syndrome":[
            {"question":"PCOS was first described by Stein and Leventhal in 1935.","options":["True","False"],"answer":"True"},
            {"question":"Decreased aromatase enzyme activity is one of the older theories of PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Hyperinsulinemia with increased SHBG supports the insulin-resistance theory of PCOS.","options":["True","False"],"answer":"False"},
            {"question":"The typical hormonal pattern in PCOS shows an LH:FSH ratio of about 3:1.","options":["True","False"],"answer":"True"},
            {"question":"PCOS commonly presents with anovulation, infertility, and oligohypomenorrhea.","options":["True","False"],"answer":"True"},
            {"question":"Acanthosis nigricans is associated with insulin resistance in PCOS.","options":["True","False"],"answer":"True"},
            {"question":"PCOS is associated with decreased androgens such as testosterone and DHEA.","options":["True","False"],"answer":"False"},
            {"question":"Ultrasound in PCOS may show a necklace appearance of peripheral follicles.","options":["True","False"],"answer":"True"},
            {"question":"According to ESHRE 2003, PCOS diagnosis requires two out of three criteria.","options":["True","False"],"answer":"True"},
            {"question":"Oligo/anovulation is one of the diagnostic criteria for PCOS.","options":["True","False"],"answer":"True"},
            {"question":"More than 10 peripheral follicles of 2-9 mm support the diagnosis of PCOS on ultrasound.","options":["True","False"],"answer":"True"},
            {"question":"An ovarian volume less than 5 ml supports PCOS diagnosis.","options":["True","False"],"answer":"False"},
            {"question":"Obesity in PCOS is associated with increased fasting insulin and reduced SHBG.","options":["True","False"],"answer":"True"},
            {"question":"BMI between 20-25 is considered normal.","options":["True","False"],"answer":"True"},
            {"question":"BMI above 30 is classified as extreme obesity.","options":["True","False"],"answer":"True"},
            {"question":"Endometriosis is listed among PCOS-like syndromes in differential diagnosis.","options":["True","False"],"answer":"False"},
            {"question":"Congenital onset favors CAH rather than PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Failure of cortisol suppression after dexamethasone favors Cushing syndrome.","options":["True","False"],"answer":"True"},
            {"question":"Weight reduction is the first step in PCOS management.","options":["True","False"],"answer":"True"},
            {"question":"Smoking decreases adrenal androgen secretion in PCOS.","options":["True","False"],"answer":"False"},
            {"question":"Metformin is used to improve insulin sensitivity in PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Bromocriptine may be used if hyperprolactinemia is present in PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Thiazolidinediones such as pioglitazone or rosiglitazone can be used to treat hyperinsulinemia in PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Ovarian drilling or wedge resection may be used in cases of marked androgen excess.","options":["True","False"],"answer":"True"},
            {"question":"Clomiphene is used to suppress ovulation in PCOS.","options":["True","False"],"answer":"False"},
            {"question":"Metformin should be continued indefinitely even after pregnancy is confirmed.","options":["True","False"],"answer":"False"},
            {"question":"If pregnancy does not occur after 12 cycles, options include gonadotrophins, ovarian drilling, IUI, or IVF.","options":["True","False"],"answer":"True"},
            {"question":"Insulin resistance is part of the modern understanding of PCOS pathogenesis.","options":["True","False"],"answer":"True"},
            {"question":"PCOS may present with amenorrhea or oligomenorrhea.","options":["True","False"],"answer":"True"},
            {"question":"The LH:FSH ratio in PCOS is typically 1:3.","options":["True","False"],"answer":"False"},
            {"question":"All three ESHRE criteria are required for PCOS diagnosis.","options":["True","False"],"answer":"False"},
            {"question":"Obesity worsens PCOS by increasing insulin and lowering SHBG.","options":["True","False"],"answer":"True"},
            {"question":"BMI 20-25 is considered obesity.","options":["True","False"],"answer":"False"},
            {"question":"Smoking reduction is recommended in PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Hyperinsulinemia may increase ovarian androgen production via IGF-1.","options":["True","False"],"answer":"True"},
            {"question":"Dopamine agonists can be used when prolactin is elevated in PCOS.","options":["True","False"],"answer":"True"},
            {"question":"OCPs can help regulate menstrual irregularities in PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Weight reduction is not necessary before treatment in PCOS.","options":["True","False"],"answer":"False"},
            {"question":"Androgen-secreting tumors are part of the differential diagnosis of PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Cortisol is suppressed after dexamethasone in Cushing syndrome.","options":["True","False"],"answer":"False"},
            {"question":"Baseline infertility evaluation in PCOS includes history, examination, semen analysis, and tubal testing.","options":["True","False"],"answer":"True"}

        ],
        "أسئلة عامة":[
            {"question":"Endometriosis is defined as the presence of functional endometrial tissue in abnormal sites.","options":["True","False"],"answer":"True"},
            {"question":"The most common site of pelvic endometriosis is the ovaries.","options":["True","False"],"answer":"True"},
            {"question":"Chocolate cyst is a large ovarian cyst containing blood in endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Sampson’s theory suggests retrograde menstruation as a cause of endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Meyer’s metaplasia theory suggests peritoneal epithelium can transform into endometrial epithelium.","options":["True","False"],"answer":"True"},
            {"question":"Risk of endometriosis is seven times higher if a first-degree relative is affected.","options":["True","False"],"answer":"True"},
            {"question":"Adenomyosis is the presence of endometrial tissue within uterine muscle.","options":["True","False"],"answer":"True"},
            {"question":"The main symptoms of endometriosis are infertility and pelvic pain.","options":["True","False"],"answer":"True"},
            {"question":"Dysmenorrhea in endometriosis starts a few days before menses and increases during menstruation.","options":["True","False"],"answer":"True"},
            {"question":"Deep dyspareunia is a symptom of endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"CA-125 increases in endometriosis and can be used for monitoring treatment.","options":["True","False"],"answer":"True"},
            {"question":"Laparoscopy is the first tool for diagnosis, staging, and treatment of endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Pregnancy is considered a protective and therapeutic factor in endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Danazol is used in the treatment of endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"GnRH analogues are used in treatment of endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"PCOS was first described by Stein and Leventhal in 1935.","options":["True","False"],"answer":"True"},
            {"question":"Insulin resistance with hyperinsulinemia is a modern theory for PCOS pathogenesis.","options":["True","False"],"answer":"True"},
            {"question":"In PCOS, LH is increased and FSH is decreased.","options":["True","False"],"answer":"True"},
            {"question":"LH:FSH ratio in PCOS is typically 3:1.","options":["True","False"],"answer":"True"},
            {"question":"Anovulation and infertility are common clinical features of PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Hirsutism in PCOS is due to increased ovarian androgens.","options":["True","False"],"answer":"True"},
            {"question":"Acanthosis nigricans is a sign associated with PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Ultrasound in PCOS shows necklace appearance of the ovaries.","options":["True","False"],"answer":"True"},
            {"question":"According to ESHRE 2003, PCOS diagnosis requires 2 out of 3 criteria.","options":["True","False"],"answer":"True"},
            {"question":"Metformin is used in PCOS to improve insulin sensitivity.","options":["True","False"],"answer":"True"},
            {"question":"Laparoscopic ovarian drilling is a surgical treatment option for PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Wedge resection reduces ovarian stroma and androgen production.","options":["True","False"],"answer":"True"},
            {"question":"Obesity is commonly associated with PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Clomiphene citrate is a first-line drug for ovulation induction in PCOS.","options":["True","False"],"answer":"True"},
            {"question":"PCOS is associated with increased risk of type 2 diabetes mellitus.","options":["True","False"],"answer":"True"},
            {"question":"The incidence of infertility has decreased nowadays.","options":["True","False"],"answer":"False"},
            {"question":"Unexplained infertility contributes to about 30% of infertility cases.","options":["True","False"],"answer":"False"},
            {"question":"Mumps may lead to decreased semen production in males.","options":["True","False"],"answer":"True"},
            {"question":"Varicocele is not related to male infertility.","options":["True","False"],"answer":"False"},
            {"question":"Tubal factor contributes to about 1% of female infertility.","options":["True","False"],"answer":"False"},
            {"question":"The first step in investigating an infertile couple is hysteroscopy.","options":["True","False"],"answer":"False"},
            {"question":"Normal sperm count should be more than 20 million/ml.","options":["True","False"],"answer":"True"},
            {"question":"Normal sperm motility should be more than 10% at 2 hours after ejaculation.","options":["True","False"],"answer":"True"},
            {"question":"Testicular biopsy helps differentiate azoospermia due to testicular damage from bilateral vas obstruction.","options":["True","False"],"answer":"True"},
            {"question":"Serum LH peak at mid-cycle is more than 100 mIU/ml.","options":["True","False"],"answer":"True"},
            {"question":"The incidence of infertility is about 70%.","options":["True","False"],"answer":"False"},
            {"question":"Ovarian factor is one of the causes of female infertility.","options":["True","False"],"answer":"True"},
            {"question":"Endometriosis is a common cause of female infertility.","options":["True","False"],"answer":"True"},
            {"question":"Polycystic ovary syndrome is a common cause of anovulatory infertility.","options":["True","False"],"answer":"True"},
            {"question":"Advanced maternal age is associated with decreased fertility.","options":["True","False"],"answer":"True"},
            {"question":"The failure rate of the safe period method is 2-20 per 100 woman-years.","options":["True","False"],"answer":"True"},
            {"question":"The failure rate of the male condom is 1 per 100 woman-years.","options":["True","False"],"answer":"False"},
            {"question":"Copper-mediated IUCDs are non-medicated devices.","options":["True","False"],"answer":"False"},
            {"question":"Multiload loop is one of the copper-mediated devices.","options":["True","False"],"answer":"True"},
            {"question":"The failure rate of Lippes loop is 1-2 per 100 woman-years.","options":["True","False"],"answer":"False"},
            {"question":"Pelvic infection is not a side effect of IUCD.","options":["True","False"],"answer":"False"},
            {"question":"Combined oral contraceptive pills contain estrogen alone.","options":["True","False"],"answer":"False"},
            {"question":"The failure rate of lactational contraception is 2-20 per 100 woman-years.","options":["True","False"],"answer":"False"},
            {"question":"The failure rate of coitus interruptus is 1 per 100 woman-years.","options":["True","False"],"answer":"False"},
            {"question":"Lippes loop is a non-medicated IUCD.","options":["True","False"],"answer":"True"},
            {"question":"Multiload loop is one of the hormonal medicated devices.","options":["True","False"],"answer":"False"},
            {"question":"The failure rate of Depo-Provera is 1-2 per 100 woman-years.","options":["True","False"],"answer":"False"},
            {"question":"Pelvic abscess is not a side effect of IUCD.","options":["True","False"],"answer":"False"},
            {"question":"Oral contraceptive pills contain both estrogen and progestogen.","options":["True","False"],"answer":"True"},
            {"question":"IUCD can cause menorrhagia as a side effect.","options":["True","False"],"answer":"True"},
            {"question":"Spironolactone can be used for treatment of premenstrual tension syndrome.","options":["True","False"],"answer":"True"},
            {"question":"Dysmenorrhea means pain occurs during sexual intercourse.","options":["True","False"],"answer":"False"},
            {"question":"Premenstrual tension syndrome occurs after menstruation.","options":["True","False"],"answer":"False"},
            {"question":"Mastalgia is one of the symptoms of premenstrual tension syndrome.","options":["True","False"],"answer":"True"},
            {"question":"Oral contraceptive pills can be used for treating premenstrual tension syndrome.","options":["True","False"],"answer":"True"},
            {"question":"Secondary dysmenorrhea occurs more in virgins.","options":["True","False"],"answer":"False"},
            {"question":"Prolactin may be increased in premenstrual tension syndrome.","options":["True","False"],"answer":"True"},
            {"question":"Dysmenorrhea is classified into primary and secondary types.","options":["True","False"],"answer":"True"},
            {"question":"Primary dysmenorrhea occurs typically in older multiparous women.","options":["True","False"],"answer":"False"},
            {"question":"Prostaglandins play a major role in the pathogenesis of primary dysmenorrhea.","options":["True","False"],"answer":"True"},
            {"question":"NSAIDs are considered first-line treatment for primary dysmenorrhea.","options":["True","False"],"answer":"True"},
            {"question":"Secondary dysmenorrhea is usually due to an underlying pelvic pathology.","options":["True","False"],"answer":"True"},
            {"question":"Common causes of secondary dysmenorrhea include endometriosis and fibroids.","options":["True","False"],"answer":"True"},
            {"question":"Premenstrual tension syndrome occurs exclusively in the luteal phase of the menstrual cycle.","options":["True","False"],"answer":"True"},
            {"question":"Vitamin B6 supplementation may be used in the management of PMS.","options":["True","False"],"answer":"True"},
            {"question":"In antenatal care there are frequent visits.","options":["True","False"],"answer":"True"},
            {"question":"In antenatal care there is a role for doctors and the nursing team.","options":["True","False"],"answer":"True"},
            {"question":"Folic acid must be used during the first 12 weeks of pregnancy.","options":["True","False"],"answer":"True"},
            {"question":"Offensive lochia indicates infection.","options":["True","False"],"answer":"True"},
            {"question":"Postpartum hemorrhage is one of the complications of anemia in pregnancy.","options":["True","False"],"answer":"True"},
            {"question":"In iron deficiency anemia, MCV decreases.","options":["True","False"],"answer":"True"},
            {"question":"Ferrous salts can be used to treat iron deficiency anemia.","options":["True","False"],"answer":"True"},
            {"question":"Vesicular mole is one of the causes of DIC in pregnancy.","options":["True","False"],"answer":"True"},
            {"question":"Episiotomy must be done at crowning if indicated.","options":["True","False"],"answer":"True"},
            {"question":"Detection of fetal distress is one of the values of the partogram.","options":["True","False"],"answer":"True"},
            {"question":"Failure of labour progress can be detected using a partogram.","options":["True","False"],"answer":"True"},
            {"question":"Pelvic examination may be done during antenatal care.","options":["True","False"],"answer":"True"},
            {"question":"In DIC, bleeding time is prolonged.","options":["True","False"],"answer":"True"},
            {"question":"In DIC, clotting time is prolonged.","options":["True","False"],"answer":"True"},
            {"question":"Ultrasound is valuable in the first antenatal visit.","options":["True","False"],"answer":"True"},
            {"question":"Backache commonly occurs in pregnant women.","options":["True","False"],"answer":"True"},
            {"question":"Backache in pregnancy may be due to decreased estrogen.","options":["True","False"],"answer":"False"},
            {"question":"Calcium is one of the general lines of treatment of menopause.","options":["True","False"],"answer":"True"},
            {"question":"Antenatal care is part of preventive obstetrics.","options":["True","False"],"answer":"True"},
            {"question":"The first trimester extends from 12 to 28 weeks of gestation.","options":["True","False"],"answer":"False"},
            {"question":"Urine analysis is one of the routine investigations in antenatal care.","options":["True","False"],"answer":"True"},
            {"question":"Pregnant women should decrease water intake.","options":["True","False"],"answer":"False"},
            {"question":"Lochia is the uterine discharge during pregnancy.","options":["True","False"],"answer":"False"},
            {"question":"Lochia is a pathological condition.","options":["True","False"],"answer":"False"},
            {"question":"The first stage of lochia is lochia serosa.","options":["True","False"],"answer":"False"},
            {"question":"Sudden suppression of lochia is beneficial.","options":["True","False"],"answer":"False"},
            {"question":"Postnatal care program is of no value.","options":["True","False"],"answer":"False"},
            {"question":"Persistence of vaginal bleeding for 6 weeks after delivery is normal.","options":["True","False"],"answer":"False"},
            {"question":"Health education has no value in postnatal care.","options":["True","False"],"answer":"False"},
            {"question":"Choice of contraception is not one of the aims of postnatal care.","options":["True","False"],"answer":"False"},
            {"question":"The first visit after labour is valuable.","options":["True","False"],"answer":"True"},
            {"question":"Macrosomia is not a complication of postterm pregnancy.","options":["True","False"],"answer":"False"},
            {"question":"In postterm pregnancy, nails are below fingertips.","options":["True","False"],"answer":"False"},
            {"question":"In postterm pregnancy, there is excessive vernix.","options":["True","False"],"answer":"False"},
            {"question":"In postterm pregnancy, the skin is dry.","options":["True","False"],"answer":"True"},
            {"question":"Anemia means increased hematocrit value.","options":["True","False"],"answer":"False"},
            {"question":"Folic acid deficiency anemia is the most common anemia in pregnancy.","options":["True","False"],"answer":"False"},
            {"question":"Parenteral iron can be used in pregnancy to treat iron deficiency anemia.","options":["True","False"],"answer":"True"},
            {"question":"Oral iron can be used in malabsorption states.","options":["True","False"],"answer":"False"},
            {"question":"Iron deficiency anemia is macrocytic anemia.","options":["True","False"],"answer":"False"},
            {"question":"Historical factors can cause preterm labour.","options":["True","False"],"answer":"True"},
            {"question":"Varicocele is a cause of preterm labour.","options":["True","False"],"answer":"True"},
            {"question":"Protocol of anemia investigation is not essential.","options":["True","False"],"answer":"False"},
            {"question":"Incidence of anemia in pregnancy has decreased nowadays.","options":["True","False"],"answer":"True"},
            {"question":"Postterm pregnancy accounts for about 30% of pregnancies.","options":["True","False"],"answer":"False"},
            {"question":"Mumps may lead to abortion.","options":["True","False"],"answer":"True"},
            {"question":"Hypothyroidism is not related to abortion.","options":["True","False"],"answer":"False"},
            {"question":"DIC contributes to causes of bleeding in pregnancy.","options":["True","False"],"answer":"True"},
            {"question":"The first step in anemia investigation is hysteroscopy.","options":["True","False"],"answer":"False"},
            {"question":"Normal RBC count is more than 5 million/ml.","options":["True","False"],"answer":"True"},
            {"question":"Normal hemoglobin in pregnancy is more than 7 gm%.","options":["True","False"],"answer":"False"},
            {"question":"Second stage of labour lasts about 4–5 hours.","options":["True","False"],"answer":"False"},
            {"question":"Partogram is used during pregnancy.","options":["True","False"],"answer":"False"},
            {"question":"Copper is a drug used during pregnancy.","options":["True","False"],"answer":"False"},
            {"question":"Multigravida means a woman pregnant for the first time.","options":["True","False"],"answer":"False"},
