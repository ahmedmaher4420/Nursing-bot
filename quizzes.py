quizzes = {
    ...
    "طب نسا":{
        "ANC":[
            ...
            {"question":"Which follow-up plan fits a high-risk pregnancy most accurately?","options":["Monthly until 40 weeks","Every 2 weeks until 28 weeks, then weekly until 36 weeks, then hospitalization from 36 weeks until delivery","Every month until the onset of labor","Weekly only after 36 weeks"],"answer":"Every 2 weeks until 28 weeks, then weekly until 36 weeks, then hospitalization from 36 weeks until delivery"},
            {"question":"Which of the following should be included in the booking visit?","options":["Only blood pressure and weight","Complete history, general examination, abdominal examination, and vaginal examination","Only ultrasound and discharge medication","Antenatal education without physical examination"],"answer":"Complete history, general examination, abdominal examination, and vaginal examination"},
            {"question":"Which investigation is part of the routine tests in the first ANC visit?","options":["Hepatitis B surface antigen","Urine analysis for proteins, glycosuria, and pus cells","Rubella antibodies only","Cervical culture only"],"answer":"Urine analysis for proteins, glycosuria, and pus cells"},
            {"question":"Which item is listed as an additional test rather than a routine one in the first visit?","options":["Blood Hb%","Blood glucose level","Hepatitis B surface antigen","ABO and Rh typing"],"answer":"Hepatitis B surface antigen"},
            {"question":"At every subsequent ANC visit, which combination should be checked?","options":["Weight gain, blood pressure, fundal height, and fetal heart rate","Urine culture, Hb%, and ultrasound","Mother’s appetite, sleep pattern, and skin color","Pelvic X-ray and serum electrolytes"],"answer":"Weight gain, blood pressure, fundal height, and fetal heart rate"},
            {"question":"Which advice about smoking during pregnancy is correct?","options":["Light smoking is acceptable if nutrition is good","Heavy smoking may be associated with IUGR and even IUFD","Smoking should be stopped only in the last month","Smoking affects only the mother, not the fetus"],"answer":"Heavy smoking may be associated with IUGR and even IUFD"},
            {"question":"Why is sexual intercourse discouraged in late pregnancy according to the lecture?","options":["To prevent morning sickness","To avoid premature rupture of membranes","To reduce fetal movement","To improve calcium absorption"],"answer":"To avoid premature rupture of membranes"},
            {"question":"Which symptom is considered a warning sign and needs urgent attention?","options":["Mild heartburn","Increased vaginal discharge","Continuous headache","Leg cramps"],"answer":"Continuous headache"},
            {"question":"What is the recommended total caloric intake per day during pregnancy in the lecture?","options":["1800 kcal","2200 kcal","2400 kcal","3000 kcal"],"answer":"2400 kcal"},
            {"question":"Which nutrient pattern best matches the lecture’s pregnancy diet advice?","options":["Increased carbohydrates, decreased protein, and reduced fluids","Higher protein intake, same carbohydrate amount, and more fluids","Low protein, high fat, and restricted fluids","No change is needed in diet"],"answer":"Higher protein intake, same carbohydrate amount, and more fluids"},
            {"question":"How much iron requirement is estimated for the whole pregnancy?","options":["About 500 mg","About 750 mg","About 1 gram","About 2 grams"],"answer":"About 1 gram"},
            {"question":"Approximately how much elemental iron per day is needed in pregnancy because absorption is only 10–15%?","options":["5–10 mg/day","15–20 mg/day","30–40 mg/day","60–80 mg/day"],"answer":"30–40 mg/day"},
            {"question":"When is iron supplementation usually most important?","options":["Only in the first trimester","Mainly in the second half of pregnancy","Only during labor","Only during lactation"],"answer":"Mainly in the second half of pregnancy"},
            {"question":"Which mineral deficiency may lead to poor appetite, impaired healing, PROM, and IUGR?","options":["Iron","Zinc","Selenium","Chromium"],"answer":"Zinc"},
            {"question":"Deficiency of which element may cause goiter and cretinism?","options":["Iodine","Fluoride","Chromium","Phosphorus"],"answer":"Iodine"},
            {"question":"Deficiency of which trace element may increase the risk of dental caries?","options":["Selenium","Fluoride","Zinc","Iron"],"answer":"Fluoride"},
            {"question":"Which vitamin deficiency is classically linked with neural tube defects and adverse pregnancy outcomes?","options":["Vitamin A","Vitamin D","Folic acid","Vitamin C"],"answer":"Folic acid"},
            {"question":"Which vitamin deficiency is associated with osteomalacia in the mother and rickets in the baby?","options":["Vitamin A","Vitamin D","Vitamin B complex","Vitamin C"],"answer":"Vitamin D"},
            {"question":"Which formula is used clinically to estimate fetal weight in cephalic presentation?","options":["Weight = (fundal height + n) x 155","Weight = (fundal height - n) x 155","Weight = (fundal height × n) + 155","Weight = (fundal height ÷ n) x 155"],"answer":"Weight = (fundal height - n) x 155"},
            {"question":"A woman in late pregnancy presents with gush of fluid, headache, and blurred vision. What is the MOST appropriate interpretation?","options":["Normal pregnancy discomforts","Warning signs requiring urgent evaluation","Expected hormonal changes","Diet-related symptoms"],"answer":"Warning signs requiring urgent evaluation"},
            {"question":"A pregnant woman at 30 weeks is classified as high-risk. What is the MOST appropriate follow-up frequency now?","options":["Monthly visits","Weekly follow-up","No follow-up needed","Hospital admission immediately"],"answer":"Weekly follow-up"},
            {"question":"Antenatal care focuses mainly on treating complications after they appear rather than preventing them.","options":["True","False"],"answer":"False"},
            {"question":"Screening in antenatal care aims to distinguish high-risk pregnancies from low-risk ones.","options":["True","False"],"answer":"True"},
            {"question":"High-risk pregnancy may require hospitalization starting from 36 weeks until delivery.","options":["True","False"],"answer":"True"},
            {"question":"Urine analysis in ANC can detect protein, glucose, and infection indicators.","options":["True","False"],"answer":"True"},
            {"question":"Persistent headache and blurred vision are considered warning signs in pregnancy.","options":["True","False"],"answer":"True"},
            {"question":"Protein intake should be increased during pregnancy.","options":["True","False"],"answer":"True"},
            {"question":"Iron supplementation may cause nausea and vomiting.","options":["True","False"],"answer":"True"},
            {"question":"Zinc deficiency may contribute to IUGR and PROM.","options":["True","False"],"answer":"True"},
            {"question":"Iodine deficiency can lead to cretinism.","options":["True","False"],"answer":"True"},
            {"question":"Folic acid deficiency is linked to neural tube defects.","options":["True","False"],"answer":"True"},
            {"question":"Johnson’s formula uses fundal height to estimate fetal weight.","options":["True","False"],"answer":"True"},
            {"question":"According to the provided material, what is the primary objective of screening the entire pregnant population during Antenatal Care (A.N.C.)?","options":["To replace standard clinical examinations with imaging techniques like U/S for earlier detection.","To ensure every pregnant woman is hospitalized starting at 36 weeks for delivery preparation.","To classify pregnancies as high risk (HRP) or low risk (LRP) and provide appropriate management levels.","To provide universal iron and folic acid supplementation regardless of patient history or risk level."],"answer":"To classify pregnancies as high risk (HRP) or low risk (LRP) and provide appropriate management levels."},
            {"question":"Why is sexual intercourse specifically discouraged during the first trimester and the late months of pregnancy?","options":["To decrease the incidence of abortion and avoid premature rupture of membranes (PROM).","To minimize the risk of IUGR and IUFD associated with physical activity.","To ensure adequate maternal rest of 8 hours at night and 2 hours in the afternoon.","To prevent the onset of gestational diabetes and maternal hypertension."],"answer":"To decrease the incidence of abortion and avoid premature rupture of membranes (PROM)."},
            {"question":"Regarding dietary intake during pregnancy, what is the recommended daily amount of carbohydrates (CHO)?","options":["300 gm/d","90−100 gm/d","2400−2500 gm/d","1.2 gm/d"],"answer":"300 gm/d"},
            {"question":"Which of the following constitutes a 'major disturbance' or warning sign that requires immediate patient instruction?","options":["Continuous headache and blurred vision.","Constipation and high heel discomfort.","Ptyalism and heart burn.","Increased vaginal discharge and leg cramps."],"answer":"Continuous headache and blurred vision."},
            {"question":"What is the recommended frequency of visits for a low-risk pregnancy (LRP) during the final month of gestation (36−40 weeks)?","options":["Once every week.","Hospitalization until delivery.","Once every month.","Once every two weeks."],"answer":"Once every week."},
            {"question":"Which test is categorized as an 'Other test' rather than a 'Routine investigation' during the booking visit?","options":["Urine analysis for glycosuria.","ABO and Rh blood typing.","Blood glucose level.","Toxoplasmosis antibodies."],"answer":"Toxoplasmosis antibodies."},
            {"question":"In the calculation of iron requirements, how much iron is estimated to be needed for the expansion of maternal blood volume?","options":["1000 mg","250 mg","300 mg","500 mg"],"answer":"1000 mg"},
            {"question":"Based on the 10-15% absorption rate of iron, what is the recommended daily intake of elementary iron for a pregnant woman?","options":["30−40 mg","60−120 \\mug%","1 mg","4 mg"],"answer":"30−40 mg"},
            {"question":"What is the clinical significance of Selenium during pregnancy as described in the text?","options":["It is an essential component of glutathione peroxidase, which helps avoid free radicals.","Its deficiency leads to dental caries.","It is required in the same daily amount as Calcium (1.2 gm/d).","It facilitates the attachment of insulin to peripheral receptors."],"answer":"It is an essential component of glutathione peroxidase, which helps avoid free radicals."},
            {"question":"A deficiency in Zinc during pregnancy is associated with which of the following complications?","options":["Goiter and critinism.","Post-partum hemorrhage (PPH) and scurvy.","Premature rupture of membranes (PROM) and impaired healing.","Neural tube defects (NTD) and abortion."],"answer":"Premature rupture of membranes (PROM) and impaired healing."},
            {"question":"Using Johnson's formula, what is the estimated fetal weight for a cephalic presentation where the fundal height is 34 cm and the vertex is above the ischial spine?","options":["5270 gm","3565 gm","3410 gm","3720 gm"],"answer":"3410 gm"},
            {"question":"What is the recommended daily intake of Vitamin D for a pregnant woman, and what are the risks of its deficiency?","options":["6000 IU/d; deficiency causes dry skin and decreased epithelium.","1 mg/d; deficiency causes NTD and anemia.","600 IU/d; deficiency causes Osteomalacia in the mother and Rickets in the baby.","30 mg/d; deficiency causes vomiting and beri beri."],"answer":"600 IU/d; deficiency causes Osteomalacia in the mother and Rickets in the baby."},
            {"question":"Which specific item is NOT listed as a check required 'at all visits' during subsequent ANC care?","options":["Fundal level measurement.","Vaginal examination.","Maternal weight gain and blood pressure (A.B.P).","Auscultation of Fetal Heart Rate (F.H.R)."],"answer":"Vaginal examination."},
            {"question":"During which period of pregnancy is iron supplementation generally emphasized, and why?","options":["Only during lactation; iron requirements are highest after delivery.","The first trimester; it is critical for preventing neural tube defects.","Immediately after 12 weeks; to prevent nausea and vomiting.","The second half; iron levels in the first trimester remain similar to non-pregnant levels."],"answer":"The second half; iron levels in the first trimester remain similar to non-pregnant levels."},
            {"question":"What is the recommended total caloric intake per day during pregnancy according to the 'Nutrition (diet)' section?","options":["3000 Kcal/day","2400 Kcal/day","2000 Kcal/day","2500 Kcal/day"],"answer":"2400 Kcal/day"},
            {"question":"Which mineral deficiency is specifically linked to goiter and cretinism in the provided material?","options":["Fluoride","Iodine","Zinc","Calcium"],"answer":"Iodine"},
            {"question":"What is the stated transport form of iron in the human body?","options":["Myoglobin","Ferritin","Heme","Transferrin"],"answer":"Transferrin"},
            {"question":"For a High Risk Pregnancy (HRP), what is the clinical management protocol starting from 36 weeks until delivery?","options":["Hospitalization.","Weekly clinic visits.","Complete bed rest at home.","Bi-weekly clinic visits."],"answer":"Hospitalization."},
            {"question":"What is the recommended daily intake of Vitamin C, and which complication does it help prevent?","options":["6000 IU/d; Dry skin.","60 mg/d; Post-partum hemorrhage (PPH).","15 mg/d; PROM.","30 mg/d; Beri beri."],"answer":"60 mg/d; Post-partum hemorrhage (PPH)."},
            {"question":"Chromium is described as important for which physiological action during pregnancy?","options":["Action of insulin and its attachment to peripheral receptors.","Prevention of dental caries through enamel strength.","Catalyzing hydrogen peroxide into water.","Development of the fetal skeleton in the late months."],"answer":"Action of insulin and its attachment to peripheral receptors."},
            {"question":"In the context of Antenatal Care, what does 'Booking visit' refer to?","options":["The weekly visits that occur after 36 weeks.","The final visit before labor to book the hospital bed.","The first visit where complete history and instructions are given.","A visit specifically for ultrasound (U/S) imaging only."],"answer":"The first visit where complete history and instructions are given."},
            {"question":"Which of the following describes the daily calcium requirement during pregnancy and how it can be met?","options":["1200 gm/d, to maintain the maternal skeleton.","30 gm/d, requiring concentrated pharmaceutical supplements.","4 mg/d, primarily absorbed from red meat.","1.2 gm/d, which can be replaced by milk and milk products."],"answer":"1.2 gm/d, which can be replaced by milk and milk products."},
            {"question":"The total body iron of an adult young female is estimated to be:","options":["2−2.5 gm","4 gm","1200 gm","1 gm"],"answer":"2−2.5 gm"},
            {"question":"Folic acid deficiency is particularly associated with which set of risks?","options":["Neural tube defects (NTD), abortion, and IUGR.","Vomiting and cardiopathy.","Osteomalacia and dry skin.","Post-partum hemorrhage and scurvy."],"answer":"Neural tube defects (NTD), abortion, and IUGR."},
            {"question":"What is the recommended protein intake for a pregnant woman per day, according to the nutrition guidelines?","options":["300 gm/d, especially of plant origin.","15 mg/d, to avoid PROM.","90−100 gm/d, especially of animal origin.","2400 Kcal/d, to ensure fetal growth."],"answer":"90−100 gm/d, especially of animal origin."},
            {"question":"In Johnson's formula, which variable changes based on whether the vertex is above or below the ischial spine?","options":["155","n","Weight","Fundal height"],"answer":"n"},
            {"question":"Which of the following is recommended regarding maternal rest during pregnancy?","options":["12 hours of total daily rest, regardless of the time of day.","Hospitalization after 28 weeks for mandatory rest.","8 hours at night and 1−2 hours in the afternoon.","Complete bed rest throughout the first trimester to avoid abortion."],"answer":"8 hours at night and 1−2 hours in the afternoon."},
            {"question":"What is the purpose of increased fluid intake in the maternal diet?","options":["To avoid constipation.","To maintain amniotic fluid levels and prevent PROM.","To prevent urinary tract infections (UTI) and dysuria.","To dilute blood glucose and prevent gestational diabetes."],"answer":"To avoid constipation."},
            {"question":"Which of the following is a symptom of Vitamin B complex deficiency listed in the text?","options":["Goiter and critinism.","Rickets and osteomalacia.","Beri beri and vomiting.","Scurvy and hemorrhage."],"answer":"Beri beri and vomiting."},
            {"question":"What is the total iron need all over pregnancy, and how is the daily requirement calculated?","options":["1.2 gm total; matching the daily calcium intake.","4 gm total; matching the total iron in a male body.","1 gm total; calculated as 1000 mg/250 days of pregnancy.","500 mg total; calculated based on blood volume expansion."],"answer":"1 gm total; calculated as 1000 mg/250 days of pregnancy."},
            {"question":"Using Johnson's formula to estimate fetal weight, what value should be assigned to the constant n if the vertex is found to be above the ischial spine?","options":["11","13","155","12"],"answer":"13"},
            {"question":"Which of the following is the primary physiological reason for the 500 mg requirement of iron during pregnancy according to the provided material?","options":["Daily basal iron loss over the gestational period","Expansion of maternal blood volume","Development of the fetus and placenta","Prevention of postpartum haemorrhage"],"answer":"Development of the fetus and placenta"},
            {"question":"According to the protocol for High-Risk Pregnancy (HRP), what is the required frequency of antenatal visits from 28 to 36 weeks of gestation?","options":["Once every month","Once every week","Once every 2 weeks","Immediate hospitalization"],"answer":"Once every 2 weeks"},
            {"question":"A deficiency in which mineral is specifically associated with the development of Premature Rupture of Membrane (PROM) and Intrauterine Growth Restriction (IUGR)?","options":["Zinc","Chromium","Iodine","Fluoride"],"answer":"Zinc"},
            {"question":"What is the recommended daily intake of Vitamin A for a pregnant woman to avoid dry skin and epithelial degradation?","options":["60 mg/d","30 mg/d","6000 IU/d","600 IU/d"],"answer":"6000 IU/d"},
            {"question":"During the booking visit, which of the following is categorized as an 'Other test' rather than a 'Routine investigation'?","options":["Toxoplasmosis antibodies","Urine analysis for proteins","ABO and Rh typing","Blood glucose level"],"answer":"Toxoplasmosis antibodies"},
            {"question":"Why is sexual intercourse specifically discouraged during the late month of pregnancy according to the guidelines?","options":["To avoid premature rupture of membrane","To prevent the onset of gestational hypertension","To avoid intrauterine growth restriction","To decrease the incidence of abortion"],"answer":"To avoid premature rupture of membrane"},
            {"question":"If iron absorption is estimated at 10%−15%, what amount of elementary iron must a pregnant woman ingest daily to meet the physiological requirement of 4 mg/d?","options":["30−40 mg","100 mg","10−20 mg","1 g"],"answer":"30−40 mg"},
            {"question":"The enzyme glutathione peroxidase, which requires selenium, serves what critical function in pregnancy?","options":["Increasing the absorption of calcium in the late third trimester","Converting hydrogen peroxide to water","Catalyzing the attachment of insulin to receptors","Expanding the maternal blood volume"],"answer":"Converting hydrogen peroxide to water"},
            {"question":"In the context of vitamin deficiencies, which condition is specifically paired with Vitamin D deficiency in the mother?","options":["Scurvy","Neural tube defects","Beri beri","Osteomalacia"],"answer":"Osteomalacia"},
            {"question":"What is the primary definition of Antenatal Care (A.N.C.) according to the provided text?","options":["An exercise-only regimen for low-risk pregnant women.","A program of preventive obstetrics to detect and correct pregnancy abnormalities.","A postpartum recovery program for mothers after birth.","A surgical intervention program for high-risk deliveries."],"answer":"A program of preventive obstetrics to detect and correct pregnancy abnormalities."},
            {"question":"How many hours of rest are recommended for a pregnant woman at night?","options":["10 hours","12 hours","6 hours","8 hours"],"answer":"8 hours"},
            {"question":"Which of the following is associated with heavy smoking during pregnancy?","options":["Gestational diabetes","Improved placental blood flow","Intrauterine growth restriction (IUGR)","Increased maternal height"],"answer":"Intrauterine growth restriction (IUGR)"},
            {"question":"What is the recommended timing for starting iron supplementation during pregnancy?","options":["After 12 weeks","Only during the last week","Starting in the second trimester of the second pregnancy only","In the first month"],"answer":"After 12 weeks"},
            {"question":"Which nutrient should be supplemented especially during the first trimester to prevent defects?","options":["Folic acid","Calcium","Chromium","Vitamin C"],"answer":"Folic acid"},
            {"question":"According to the diet system instructions, what should be the total daily caloric intake?","options":["2400−2500 kcal","3500 kcal","2000 kcal","1500 kcal"],"answer":"2400−2500 kcal"},
            {"question":"Why is increased fluid intake recommended during pregnancy?","options":["To increase blood pressure","To avoid constipation","To prevent morning sickness","To decrease amniotic fluid"],"answer":"To avoid constipation"},
            {"question":"Which of these is considered a 'major disturbance' (warning sign) that requires immediate attention?","options":["Blurred vision","Leg cramps","Increased vaginal discharge","Heart burn"],"answer":"Blurred vision"},
            {"question":"For a low-risk pregnancy (LRP), how frequent should visits be during the first 7 months?","options":["Once every trimester","Every month","Every 2 weeks","Every week"],"answer":"Every month"},
            {"question":"What happens to a woman with a high-risk pregnancy (HRP) at 36 weeks?","options":["She is discharged from ANC","She switches to monthly visits","She should be hospitalized until delivery","She is referred to a physical therapist"],"answer":"She should be hospitalized until delivery"},
            {"question":"Which of the following is a routine urine analysis test during the booking visit?","options":["Amniotic fluid volume","Drug screening","Vitamin levels","Urine proteins"],"answer":"Urine proteins"},
            {"question":"What does F.H.R. stand for in the context of ANC check-ups?","options":["Fetal Heart Rate","Female Hormone Regulation","Final Health Record","Fetal Height Ratio"],"answer":"Fetal Heart Rate"},
            {"question":"How much total iron is needed over the entire course of pregnancy?","options":["500 mg","1 gram (1000 mg)","100 mg","5 grams"],"answer":"1 gram (1000 mg)"},
            {"question":"What is the daily calcium requirement for a pregnant woman?","options":["10 g/d","0.5 g/d","3.0 g/d","1.2 g/d"],"answer":"1.2 g/d"},
            {"question":"Deficiency in which mineral may lead to goiter and cretinism?","options":["Selenium","Iodine","Zinc","Fluoride"],"answer":"Iodine"},
            {"question":"Which enzyme requires Selenium to catalyze hydrogen peroxide into water and avoid free radicals?","options":["Glutathione peroxidase","Transferrin","Amylase","Insulin"],"answer":"Glutathione peroxidase"},
            {"question":"What is a potential consequence of Vitamin D deficiency in the mother?","options":["Dry skin","Scurvy","Beri beri","Osteomalacia"],"answer":"Osteomalacia"},
            {"question":"In Johnson's formula for estimating fetal weight, what is the value of 'n' if the vertex is above the ischial spine?","options":["155","11","7","12"],"answer":"11"},
            {"question":"Which of the following is listed as a 'minor disturbance' of pregnancy?","options":["Continuous headache","Gush of water (PROM)","Abdominal pain","Ptyalism"],"answer":"Ptyalism"},
            {"question":"What is the recommended daily intake of Folic Acid during pregnancy?","options":["30 mg/d","1 mg/d","600 IU/d","60 mg/d"],"answer":"1 mg/d"},
            {"question":"Zinc deficiency during pregnancy may lead to which of the following?","options":["Cardiomyopathy","IUGR (Intrauterine growth restriction)","Dental caries","Goiter"],"answer":"IUGR (Intrauterine growth restriction)"},
            {"question":"What is the main role of Chromium in pregnancy nutrition?","options":["Facilitating insulin attachment to receptors","Preventing neural tube defects","Building fetal skeleton","Oxygen transport in blood"],"answer":"Facilitating insulin attachment to receptors"},
            {"question":"Which percentage of iron in the body is typically found as Hemoglobin (Hb)?","options":["70%","5%","100%","20−25%"],"answer":"70%"},
            {"question":"What is the recommended daily intake of Vitamin C during pregnancy?","options":["1.2 g/d","15 mg/d","6000 IU/d","60 mg/d"],"answer":"60 mg/d"},
            {"question":"During a booking visit, which test is categorized under 'Other tests' rather than routine investigations?","options":["Hb% calculation","ABO & Rh typing","Blood glucose level","Toxoplasmosis antibodies"],"answer":"Toxoplasmosis antibodies"},
            {"question":"Which of the following instructions regarding clothes is given to pregnant women?","options":["Avoid high heel shoes","Wear shoes one size smaller for better grip","Wear tight supportive belts","Only wear synthetic fabrics"],"answer":"Avoid high heel shoes"},
            {"question":"What is the recommended daily intake of protein during pregnancy?","options":["300 gm/d","30−40 gm/d","90−100 gm/d","500 gm/d"],"answer":"90−100 gm/d"},
            {"question":"Iron requirements are usually the same in the first trimester as in non-pregnancy.","options":["True","False"],"answer":"True"},
        ...
        "Contraception":{
            ...
            {"question":"Which practice improves the effectiveness of lactational contraception most?","options":["Feeding every 4 hours without night feeding","6–8 feeds daily with midnight feeding","Only daytime feeding for 10 minutes","Introducing formula milk early"],"answer":"6–8 feeds daily with midnight feeding"},
            {"question":"In the calendar method of fertility awareness, the first fertile day is calculated as the shortest cycle minus what number?","options":["10","14","18","20"],"answer":"20"},
            {"question":"In the calendar method, the last fertile day is calculated as the longest cycle minus what number?","options":["8","10","12","20"],"answer":"10"},
            {"question":"A woman with a regular 28-day cycle using the calendar method is fertile approximately between which days?","options":["1–7","8–18","10–20","14–28"],"answer":"8–18"},
            {"question":"The basal body temperature method mainly depends on the thermogenic effect of which hormone?","options":["Estrogen","Progesterone","FSH","Prolactin"],"answer":"Progesterone"},
            {"question":"According to the basal body temperature method, fertility continues until how long after the temperature rise?","options":["1 day","2 days","3 consecutive days","7 consecutive days"],"answer":"3 consecutive days"},
            {"question":"Which description best fits cervical mucus fertility signs?","options":["Thick, sticky, and absent around ovulation","Abundant, clear, and stretchable around ovulation","Always dry during ovulation","Bloody and painful around ovulation"],"answer":"Abundant, clear, and stretchable around ovulation"},
            {"question":"What is the main disadvantage of coitus interruptus?","options":["It requires expensive equipment","It has a high failure rate because pre-ejaculatory fluid may contain sperm","It causes permanent infertility","It cannot be used by healthy couples"],"answer":"It has a high failure rate because pre-ejaculatory fluid may contain sperm"},
            {"question":"Which is a non-contraceptive advantage of the male condom?","options":["Increases fertility","Protects against STD and PID","Raises the risk of cervical cancer","Causes heavier menstruation"],"answer":"Protects against STD and PID"},
            {"question":"What instruction is essential when using a male condom?","options":["Use Vaseline to improve gliding","Reuse only if intact","Apply it before penetration on an erect penis","Remove it only after the next day"],"answer":"Apply it before penetration on an erect penis"},
            {"question":"Why is Vaseline not recommended with male condoms?","options":["It increases pain","It decreases tensile strength","It causes immediate infertility","It makes the condom too dry"],"answer":"It decreases tensile strength"},
            {"question":"Which method is a barrier method designed for the female genital tract?","options":["Lactational amenorrhea","Diaphragm","Coitus interruptus","Safe period"],"answer":"Diaphragm"},
            {"question":"Which side effect is classically associated with diaphragm retention?","options":["Toxic shock syndrome","Hyperthyroidism","Jaundice","Alopecia"],"answer":"Toxic shock syndrome"},
            {"question":"The vaginal contraceptive sponge contains which active spermicidal agent?","options":["Oxytocin","Nonoxynol-9","Levonorgestrel","Copper sulfate"],"answer":"Nonoxynol-9"},
            {"question":"Which statement best describes the female condom?","options":["It is a rigid device inserted into the cervix","It is a polyurethane sheath with two rings that covers vagina and vulva","It works only by releasing hormones","It is used only after menopause"],"answer":"It is a polyurethane sheath with two rings that covers vagina and vulva"},
            {"question":"Which is a selected gynecological indication for the female condom?","options":["Severe dysmenorrhea","Superficial dyspareunia","Ovarian cancer prevention","Primary amenorrhea"],"answer":"Superficial dyspareunia"},
            {"question":"What is the main effect of spermicides when used alone?","options":["Highly effective with zero failure","Not very effective and may have failure up to 30 per 100 women-years","Works only after ovulation","Prevents ovulation centrally"],"answer":"Not very effective and may have failure up to 30 per 100 women-years"},
            {"question":"Which is a correct indication for spermicides?","options":["Primary method for all women","Adjuvant with other methods","Replacement for sterilization","Treatment of fibroids"],"answer":"Adjuvant with other methods"},
            {"question":"Which IUCD type is non-medicated?","options":["Cu T 380","Mirena","Lippes loop","Progestasert"],"answer":"Lippes loop"},
            {"question":"Which statement about copper IUCDs is correct?","options":["Copper decreases contraceptive efficacy","Copper increases contraceptive efficacy","Copper prevents bleeding completely","Copper is used only in hormone-sensitive women"],"answer":"Copper increases contraceptive efficacy"},
            {"question":"Which factor is part of the IUCD mechanism of action?","options":["Suppressing prolactin secretion","Sterile inflammatory reaction in the uterus","Direct destruction of ovarian follicles","Increasing endometrial implantation"],"answer":"Sterile inflammatory reaction in the uterus"},
            {"question":"Which is an absolute contraindication to IUCD use?","options":["Breast feeding","Nulliparity","Known or suspected pregnancy","Previous vaginal delivery"],"answer":"Known or suspected pregnancy"},
            {"question":"Why is postmenstrual IUCD insertion preferred?","options":["It causes more pain but less bleeding","Pregnancy can be excluded and the cervix is more patulous","It is the only time the device can be inserted","It avoids all complications"],"answer":"Pregnancy can be excluded and the cervix is more patulous"},
            {"question":"Which is part of post-IUCD counseling?","options":["Pull the strings to check the device weekly","Attend for check-up after one month and then annually","Avoid any follow-up unless pain occurs","Douching is encouraged after intercourse"],"answer":"Attend for check-up after one month and then annually"},
            {"question":"Which complication of IUCD commonly causes menorrhagia or metrorrhagia?","options":["Bleeding","Missed loop","Male discomfort","Pregnancy only"],"answer":"Bleeding"},
            {"question":"What is the best initial management for IUCD-related pain if no emergency cause is found?","options":["Antibiotics only","Analgesics such as anti-PG drugs","Immediate hysterectomy","No treatment is needed"],"answer":"Analgesics such as anti-PG drugs"},
            {"question":"Which IUCD complication is suggested by inability to feel the strings in the vagina?","options":["Severe anemia","Missed loop","Toxic shock syndrome","Endometrial atrophy"],"answer":"Missed loop"},
            {"question":"Which hormone is the main central action in estrogen-containing contraceptives?","options":["Stimulates ovulation","Inhibits the H-P-O axis and suppresses ovulation","Increases sperm motility","Causes cervical mucus to become thicker"],"answer":"Inhibits the H-P-O axis and suppresses ovulation"},
            {"question":"The main action of progestin in contraceptive pills is on which site?","options":["Central only","Peripheral mainly","Bone marrow","Kidney"],"answer":"Peripheral mainly"},
            {"question":"What is the main progestin effect on cervical mucus?","options":["Makes it watery and favorable to sperm penetration","Transforms it into a network pattern that blocks sperm penetration","No effect on cervical mucus","Destroys cervical mucus completely"],"answer":"Transforms it into a network pattern that blocks sperm penetration"},
            {"question":"Which side effect is more associated with estrogen in combined pills?","options":["Headache","Nausea and vomiting","Hair loss","Depression"],"answer":"Nausea and vomiting"},
            {"question":"Which condition is an absolute contraindication to steroid contraception?","options":["Migraine","Hypertension","History of thromboembolic disease","Varicose veins"],"answer":"History of thromboembolic disease"},
            {"question":"Which is a non-contraceptive indication for combined oral contraceptive pills?","options":["Tubal ligation","Dysfunctional uterine bleeding","PID treatment","Ovarian torsion"],"answer":"Dysfunctional uterine bleeding"},
            {"question":"Which progestin-only method is long acting and injectable?","options":["Microlut","DMPA","Anovlar","Gynera"],"answer":"DMPA"},
            {"question":"Which subdermal implant is biodegradable?","options":["Norplant","Implanon","Pellets","Norplant-2"],"answer":"Pellets"},
            {"question":"Which is the failure rate of injectable progestins according to the lecture?","options":["1/HWY","0.3/HWY","5/HWY","10/HWY"],"answer":"0.3/HWY"},
            {"question":"Which method is considered the most effective among those listed in the contraceptive effectiveness table?","options":["Safe period","Male condom","Tubal ligation","Coitus interruptus"],"answer":"Tubal ligation"},
            {"question":"What is a post-coital contraceptive option listed in the lecture?","options":["Progestin only pills given weekly","Mifepristone (RU 486)","Copper-free diaphragm","Lactation"],"answer":"Mifepristone (RU 486)"},
            {"question":"Which contraceptive option is preferred for newly married couples?","options":["Tubal ligation only","Safe period and male condom","IUCD only","GnRH analogues"],"answer":"Safe period and male condom"},
            {"question":"Which method is especially suitable during lactation?","options":["COCP","IUCD or POP","High-dose estrogen","Sequential pills"],"answer":"IUCD or POP"},
            {"question":"Contraception means prevention of pregnancy at will.","options":["True","False"],"answer":"True"},
            {"question":"Lactational amenorrhea works mainly through increased prolactin and decreased gonadotropins.","options":["True","False"],"answer":"True"},
            {"question":"Safe period is based on avoiding intercourse during the fertile days of the menstrual cycle.","options":["True","False"],"answer":"True"},
            {"question":"The calendar method calculates the first fertile day as the shortest cycle minus 20 days.","options":["True","False"],"answer":"True"},
            {"question":"Basal body temperature rises because of the thermogenic effect of progesterone in the second half of the cycle.","options":["True","False"],"answer":"True"},
            {"question":"Coitus interruptus is a highly reliable contraceptive method with a very low failure rate.","options":["True","False"],"answer":"False"},
            {"question":"Male condoms can help reduce the transmission of STDs and PID.","options":["True","False"],"answer":"True"},
            {"question":"Vaseline should be used with condoms because it increases tensile strength.","options":["True","False"],"answer":"False"},
            {"question":"The female condom is a polyurethane sheath that covers both vagina and vulva.","options":["True","False"],"answer":"True"},
            {"question":"Spermicides are effective as a stand-alone method with a very low failure rate.","options":["True","False"],"answer":"False"},
            {"question":"Spermicides are useful as an emergency measure after condom rupture.","options":["True","False"],"answer":"True"},
            {"question":"Oil-based products should not be used with condoms because they weaken tensile strength.","options":["True","False"],"answer":"True"},
            {"question":"Copper-containing IUCDs increase contraceptive effectiveness.","options":["True","False"],"answer":"True"},
            {"question":"IUCDs work only by preventing ovulation.","options":["True","False"],"answer":"False"},
            {"question":"Known or suspected pregnancy is an absolute contraindication to IUCD insertion.","options":["True","False"],"answer":"True"},
            {"question":"Postmenstrual IUCD insertion helps exclude pregnancy and is usually easier because the cervix is more patulous.","options":["True","False"],"answer":"True"},
            {"question":"After IUCD insertion, the patient should pull the nylon strings regularly to check placement.","options":["True","False"],"answer":"False"},
            {"question":"Bleeding, pain, pregnancy, pelvic infection, and missed loop are recognized IUCD complications.","options":["True","False"],"answer":"True"},
            {"question":"In steroid contraception, estrogen mainly acts centrally by suppressing the H-P-O axis.","options":["True","False"],"answer":"True"},
            {"question":"Progestin mainly thickens cervical mucus and reduces sperm penetration.","options":["True","False"],"answer":"True"},
            {"question":"History of thromboembolic disease is a relative contraindication to steroid contraception.","options":["True","False"],"answer":"False"},
            {"question":"Nausea and vomiting are more related to estrogen side effects in combined pills.","options":["True","False"],"answer":"True"},
            {"question":"Progestin-only pills are suitable during lactation.","options":["True","False"],"answer":"True"},
            {"question":"DMPA is a progestin-only injectable contraceptive.","options":["True","False"],"answer":"True"},
            {"question":"Norplant is a biodegradable subdermal implant.","options":["True","False"],"answer":"False"},
            {"question":"Tubal ligation is among the most effective permanent contraceptive methods.","options":["True","False"],"answer":"True"},
            {"question":"Mifepristone is listed as one of the post-coital contraceptive options.","options":["True","False"],"answer":"True"},
            {"question":"COCP may be used for non-contraceptive indications such as dysfunctional uterine bleeding.","options":["True","False"],"answer":"True"},
            {"question":"Combined oral contraceptives are preferred in women with cardiac disease over progestin-only methods.","options":["True","False"],"answer":"False"},
            {"question":"Old age above 35 years is one of the special groups for which IUCD or Depo-Provera may be considered.","options":["True","False"],"answer":"True"},
        ...
        "Dysmenorrhea":{
            ...
            {"question":"What is the most characteristic pattern of pain in primary dysmenorrhea?","options":["Dull ache beginning a week before menses","Colicky suprapubic pain starting on the first day of menstruation","Sharp unilateral pain at mid-cycle","Pain only during intercourse"],"answer":"Colicky suprapubic pain starting on the first day of menstruation"},
            {"question":"Which mechanism is most directly linked to primary dysmenorrhea in the lecture?","options":["Reduced ovarian blood flow from estrogen deficiency","Excess prostaglandins causing stronger uterine contractions","Bacterial infection of the endometrium","Mechanical distortion by fibroids"],"answer":"Excess prostaglandins causing stronger uterine contractions"},
            {"question":"Why can primary dysmenorrhea be associated with nausea and vomiting?","options":["Because of low progesterone only","Because of increased prostaglandins","Because of anemia alone","Because of uterine prolapse"],"answer":"Because of increased prostaglandins"},
            {"question":"Which of the following is a recognized abnormal uterine anatomy contributing to primary dysmenorrhea?","options":["Bicornuate uterus","Polycystic ovaries","Fibroid uterus","Endometrial polyp"],"answer":"Bicornuate uterus"},
            {"question":"A woman’s pelvic exam is completely normal, yet she has colicky menstrual pain. Which diagnosis is most likely?","options":["Primary dysmenorrhea","Congestive dysmenorrhea","Endometriosis only","Ovarian torsion"],"answer":"Primary dysmenorrhea"},
            {"question":"Which of the following is a general measure in treating primary dysmenorrhea?","options":["Routine hysterectomy","Teaching menstrual physiology and hygiene","Immediate oophorectomy","Strict bed rest for all cycles"],"answer":"Teaching menstrual physiology and hygiene"},
            {"question":"Which medical treatment is specifically aimed at reducing prostaglandin-related pain?","options":["Antiprostaglandins such as mefenamic acid","Antibiotics","Estrogen replacement only","Antifungals"],"answer":"Antiprostaglandins such as mefenamic acid"},
            {"question":"Which medication group may be used as antispasmodic therapy in dysmenorrhea?","options":["Beta-agonists and calcium channel blockers","Anticoagulants and statins","Diuretics and insulin","Beta-blockers and nitrates"],"answer":"Beta-agonists and calcium channel blockers"},
            {"question":"Which hormonal treatment may be used in primary dysmenorrhea to suppress ovulation?","options":["OCPs","Progesterone withdrawal only","GnRH agonists only","Thyroxine"],"answer":"OCPs"},
            {"question":"Which surgical option is used for cervical stenosis in severe dysmenorrhea?","options":["LUNA","Cervical dilatation","Hysterectomy","Endometrial ablation"],"answer":"Cervical dilatation"},
            {"question":"LUNA in dysmenorrhea stands for what?","options":["Laparoscopic uterine nerve ablation","Lower uterine nerve anesthesia","Lateral uterine nerve excision","Laparoscopic uterine necrosis"],"answer":"Laparoscopic uterine nerve ablation"},
            {"question":"Which form of dysmenorrhea is described as lower abdominal dull aching pain that starts several days before menses and improves with flow?","options":["Primary dysmenorrhea","Congestive dysmenorrhea","Ovarian dysmenorrhea","Membranous dysmenorrhea"],"answer":"Congestive dysmenorrhea"},
            {"question":"Congestive dysmenorrhea typically occurs in which group?","options":["Virgin women","Parous women","Adolescent girls before puberty","Postmenopausal women"],"answer":"Parous women"},
            {"question":"Which feature helps distinguish congestive dysmenorrhea from spasmodic dysmenorrhea?","options":["It begins after menstruation ends","It is not accompanied by nausea and vomiting","It occurs only in virgins","It is always caused by cervical stenosis"],"answer":"It is not accompanied by nausea and vomiting"},
            {"question":"Which of the following can cause congestive dysmenorrhea?","options":["Coitus interruptus","Simple pelvic congestion","Both are correct","Neither is correct"],"answer":"Both are correct"},
            {"question":"Which condition is specifically mentioned as a cause of congestive dysmenorrhea with a grinding pain away from midline?","options":["Endometriosis","Vaginitis","Cervical erosion","Ovarian cyst rupture"],"answer":"Endometriosis"},
            {"question":"What is the main treatment principle in congestive dysmenorrhea?","options":["Antibiotics only","Treat the underlying cause","Immediate OCP withdrawal","Reassurance alone"],"answer":"Treat the underlying cause"},
            {"question":"Which local treatment is suggested to reduce pelvic congestion in congestive dysmenorrhea?","options":["Glycerine ichthyol pessary","Vaginal estrogen cream","Copper IUCD","Pelvic binder"],"answer":"Glycerine ichthyol pessary"},
            {"question":"Membranous dysmenorrhea is best described as a form of what?","options":["Primary dysmenorrhea","Congestive dysmenorrhea","Spasmodic dysmenorrhea","Ovulatory pain"],"answer":"Spasmodic dysmenorrhea"},
            {"question":"Which finding is most typical of membranous dysmenorrhea?","options":["Large membranous casts shed with menses","Pain only during ovulation","No menstrual bleeding at all","Permanent infertility in all cases"],"answer":"Large membranous casts shed with menses"},
            {"question":"What is a classic clue that ovarian dysmenorrhea is present?","options":["Pain in both iliac fossae at once","Pain reproduced by pressure on the ovary during bimanual exam","Pain only after menopause","Pain relieved by constipation"],"answer":"Pain reproduced by pressure on the ovary during bimanual exam"},
            {"question":"Ovarian dysmenorrhea is usually located where?","options":["Midline suprapubic area only","One iliac fossa only","Lumbar area only","Right hypochondrium"],"answer":"One iliac fossa only"},
            {"question":"Which statement best describes ovulatory pain (mittelschmerz)?","options":["It lasts several days after menstruation","It is mid-cycle pain in one iliac fossa and lasts about 12 hours","It always indicates pelvic infection","It occurs only in postmenopausal women"],"answer":"It is mid-cycle pain in one iliac fossa and lasts about 12 hours"},
            {"question":"Which pattern is most consistent with premenstrual tension syndrome (PTS)?","options":["Symptoms persist all month without fluctuation","Symptoms occur in a fixed phase of the cycle and regress after menstruation","Symptoms begin only after menopause","Symptoms are caused by pelvic infection"],"answer":"Symptoms occur in a fixed phase of the cycle and regress after menstruation"},
            {"question":"Which theory is listed as a possible explanation for PTS?","options":["Increased estrogen causing salt and water retention","Excess testosterone from the ovary","Endometrial polyp formation","Chronic pelvic abscess"],"answer":"Increased estrogen causing salt and water retention"},
            {"question":"Which neurotransmitter-related change is mentioned in PTS?","options":["Decrease in dopamine with increase in prolactin","Increase in acetylcholine with decrease in cortisol","Increase in histamine with decrease in insulin","Decrease in thyroid hormone with increase in aldosterone"],"answer":"Decrease in dopamine with increase in prolactin"},
            {"question":"Which vitamin deficiency is associated with PTS in the lecture?","options":["Vitamin K only","Vitamin A and B6","Vitamin B12 and C","Vitamin D and E"],"answer":"Vitamin A and B6"},
            {"question":"Which symptom is part of the classic symptom cluster of PTS?","options":["Breast fullness and tenderness","Hemoptysis","Jaundice","Syncope only"],"answer":"Breast fullness and tenderness"},
            {"question":"Which of the following is a pharmacologic treatment option for PTS?","options":["Bromocriptine","Penicillin","Warfarin","Metformin only"],"answer":"Bromocriptine"},
            {"question":"Which drug is used in PTS because it reduces aldosterone secretion?","options":["Spironolactone","Aspirin","Atropine","Clomiphene"],"answer":"Spironolactone"},
            {"question":"Which non-pharmacological measure is recommended for PTS?","options":["High caffeine intake","Exercise techniques such as yoga","Smoking more often","High-fat diet"],"answer":"Exercise techniques such as yoga"},
            {"question":"Which dietary advice is recommended for PTS?","options":["Low fat, high protein, increased fibre","High fat, low protein, reduced fibre","Very low carbohydrate, no protein","High salt, low water"],"answer":"Low fat, high protein, increased fibre"},
            {"question":"Dysmenorrhea refers to painful menstruation that may occur just before or during menses.","options":["True","False"],"answer":"True"},
            {"question":"Primary dysmenorrhea is associated with evident pelvic disease on examination.","options":["True","False"],"answer":"False"},
            {"question":"Primary dysmenorrhea is more common in virgin and nulliparous women.","options":["True","False"],"answer":"True"},
            {"question":"The pain of primary dysmenorrhea usually starts on the first day of menstruation.","options":["True","False"],"answer":"True"},
            {"question":"Primary dysmenorrhea is commonly associated with nausea and vomiting due to prostaglandins.","options":["True","False"],"answer":"True"},
            {"question":"Correction of anemia is part of the general management of primary dysmenorrhea.","options":["True","False"],"answer":"True"},
            {"question":"OCPs may be used in primary dysmenorrhea because they suppress ovulation.","options":["True","False"],"answer":"True"},
            {"question":"Cervical dilatation may be useful when dysmenorrhea is caused by cervical stenosis.","options":["True","False"],"answer":"True"},
            {"question":"Congestive dysmenorrhea typically begins a few days before menstruation and improves when flow starts.","options":["True","False"],"answer":"True"},
            {"question":"Congestive dysmenorrhea is usually accompanied by prominent nausea and vomiting.","options":["True","False"],"answer":"False"},
            {"question":"Congestive dysmenorrhea usually occurs in parous women.","options":["True","False"],"answer":"True"},
            {"question":"Endometriosis may cause a special form of congestive dysmenorrhea with grinding pain away from the midline.","options":["True","False"],"answer":"True"},
            {"question":"Treatment of congestive dysmenorrhea should focus mainly on the cause.","options":["True","False"],"answer":"True"},
            {"question":"Membranous dysmenorrhea is common and usually mild.","options":["True","False"],"answer":"False"},
            {"question":"Membranous dysmenorrhea may present with large membranous casts passed during menstruation.","options":["True","False"],"answer":"True"},
            {"question":"Ovarian dysmenorrhea is often reproduced by pressing on the ovary during bimanual examination.","options":["True","False"],"answer":"True"},
            {"question":"Mittelschmerz pain occurs in the middle of the cycle and usually lasts about 12 hours.","options":["True","False"],"answer":"True"},
            {"question":"Premenstrual tension syndrome is caused by organic pelvic disease in most cases.","options":["True","False"],"answer":"False"},
            {"question":"Aldosterone excess is one of the proposed mechanisms in PTS.","options":["True","False"],"answer":"True"},
            {"question":"Breast tenderness and emotional instability may occur in PTS.","options":["True","False"],"answer":"True"},
            {"question":"Bromocriptine can be used in the treatment of PTS.","options":["True","False"],"answer":"True"},
            {"question":"Spironolactone may help PTS by reducing aldosterone secretion.","options":["True","False"],"answer":"True"},
            {"question":"Exercise and stress reduction are non-pharmacological measures for PTS.","options":["True","False"],"answer":"True"},
        ...
        "Endometriosis":{
            ...
            {"question":"Which of the following is considered an extra-pelvic site of endometriosis?","options":["Douglas pouch","Uterosacral ligament","Laparotomy scar","Tubes"],"answer":"Laparotomy scar"},
            {"question":"Which theory explains endometriosis by retrograde menstruation through the tubes?","options":["Meyer’s metaplasia theory","Sampson’s tubal regurgitation theory","Genetic mutation theory","Hormonal implantation theory"],"answer":"Sampson’s tubal regurgitation theory"},
            {"question":"What does Meyer’s theory propose in the pathogenesis of endometriosis?","options":["Endometrial cells spread only through lymphatics","Peritoneal epithelium can transform into endometrial epithelium","Only ovarian tissue can become ectopic","Endometriosis occurs only after surgery"],"answer":"Peritoneal epithelium can transform into endometrial epithelium"},
            {"question":"Which factor is strongly associated with a familial risk of endometriosis?","options":["Risk becomes seven times higher if a first-degree relative is affected","Risk disappears after menarche","Risk is only related to parity","Risk is lower in monozygotic twins"],"answer":"Risk becomes seven times higher if a first-degree relative is affected"},
            {"question":"Which statement about monozygotic twins and endometriosis is most accurate?","options":["No concordance has been reported","A relative risk of about 75% has been noted","Only one twin can ever be affected","Risk is lower than in unrelated women"],"answer":"A relative risk of about 75% has been noted"},
            {"question":"Which autoimmune association is mentioned with endometriosis?","options":["SLE","Rheumatoid fever","Myasthenia gravis only","Addison disease"],"answer":"SLE"},
            {"question":"Which of the following is a predisposing factor for endometriosis?","options":["Cervical obstruction due to stenosis","Early menopause","Pelvic irradiation only","Toxic shock syndrome"],"answer":"Cervical obstruction due to stenosis"},
            {"question":"Which procedure performed during the premenstrual or menstrual phase may predispose to endometriosis?","options":["Appendectomy","D&C or HSG","Hernia repair","Cesarean section only"],"answer":"D&C or HSG"},
            {"question":"What is the classic gross appearance of ovarian endometriosis?","options":["Honeycomb cysts","Chocolate cyst","Dermoid cyst with hair","Simple serous cyst"],"answer":"Chocolate cyst"},
            {"question":"What is the microscopic finding in endometriosis?","options":["Only fibrosis without glands","Endometrial glands and stroma","Squamous epithelium with keratin","Atypical malignant cells only"],"answer":"Endometrial glands and stroma"},
            {"question":"Which gross finding is typical of pelvic endometriosis in Douglas pouch?","options":["Single smooth cyst with clear fluid","Multiple small dark spots with adhesions","Large calcified mass only","No visible lesions at surgery"],"answer":"Multiple small dark spots with adhesions"},
            {"question":"What does the term \"frozen pelvis\" usually imply in endometriosis?","options":["A uterus fixed by extensive adhesions","A uterus enlarged by fibroids only","Acute pelvic infection","A normal pelvis with mild pain"],"answer":"A uterus fixed by extensive adhesions"},
            {"question":"Which symptom is the main complaint in symptomatic pelvic endometriosis?","options":["Vomiting","Pain","Fever","Weight loss"],"answer":"Pain"},
            {"question":"Which pattern of pain is typical in endometriosis-related dysmenorrhea?","options":["Starts after menses and improves before flow","Starts a few days before menses and worsens during the period","Occurs only at ovulation","Occurs only after sexual intercourse"],"answer":"Starts a few days before menses and worsens during the period"},
            {"question":"Which pain description is most consistent with endometriosis?","options":["Dull and strictly midline","Grinding and away from the midline","Burning and epigastric","Cramping only in the shoulder"],"answer":"Grinding and away from the midline"},
            {"question":"Which of the following is a recognized complication of bladder involvement in endometriosis?","options":["Pneumaturia","Menuria","Hematemesis","Proteinuria"],"answer":"Menuria"},
            {"question":"Which intestinal complication may occur when endometriosis extends to the bowel?","options":["Intestinal obstruction","Appendicitis always","Gastric outlet obstruction","Anal fissure only"],"answer":"Intestinal obstruction"},
            {"question":"Which investigation is considered the first tool for diagnosis, staging, treatment, and follow-up of endometriosis?","options":["Plain pelvic X-ray","Laparoscopy","Endometrial biopsy only","Urine culture"],"answer":"Laparoscopy"},
            {"question":"In Acosta staging, which finding best fits severe endometriosis?","options":["Small scattered nodules with no adhesions","Ovarian endometrioma under 2.5 cm","Obliterated Douglas pouch with severe scarring and adhesions","Only mild scarring without ovarian involvement"],"answer":"Obliterated Douglas pouch with severe scarring and adhesions"},
            {"question":"Which marker may be elevated in endometriosis but is not specific?","options":["CA-125","AFP","Troponin","TSH"],"answer":"CA-125"},
            {"question":"Which statement about CA-125 is most accurate?","options":["It is specific for endometriosis only","It can help monitor treatment response and recurrence","It is never elevated in ovarian disease","It replaces laparoscopy as the best diagnostic test"],"answer":"It can help monitor treatment response and recurrence"},
            {"question":"Which factor is the best prophylaxis against endometriosis according to the lecture?","options":["Early pregnancy","Pregnancy","Menopause","High-dose antibiotics"],"answer":"Pregnancy"},
            {"question":"Which treatment approach is appropriate for a young woman with minimal symptoms and minimal lesions who wants pregnancy?","options":["Immediate radical surgery","Expectant treatment with follow-up","Permanent sterilization","Chemotherapy"],"answer":"Expectant treatment with follow-up"},
            {"question":"Which is the main line of treatment for marked symptoms with minimal lesion?","options":["Hormonal treatment","Hysterectomy","No treatment","Radiotherapy"],"answer":"Hormonal treatment"},
            {"question":"Which drug is described as the most common current treatment for endometriosis?","options":["Danazol","Progesterone only","Aspirin","Metformin"],"answer":"Danazol"},
            {"question":"What is the mechanism of danazol in endometriosis?","options":["It increases estrogen production","It creates an androgenic environment and suppresses gonadotropins and ovarian steroidogenesis","It directly cures adhesions surgically","It blocks only prolactin secretion"],"answer":"It creates an androgenic environment and suppresses gonadotropins and ovarian steroidogenesis"},
            {"question":"Which side effect is most characteristic of danazol?","options":["Virilization and acne","Severe hypocalcemia","Jaundice from copper toxicity","Profound bradycardia"],"answer":"Virilization and acne"},
            {"question":"Which advantage does gestrinone have over danazol?","options":["It has no hormonal effect","It has a longer half-life and fewer menopausal side effects","It is always given daily","It is less effective in pain control"],"answer":"It has a longer half-life and fewer menopausal side effects"},
            {"question":"Which complication is the most serious concern with GnRH analogues in endometriosis?","options":["Osteoporosis","Hyperglycemia","Cataract formation","Hearing loss"],"answer":"Osteoporosis"},
            {"question":"Why is add-back therapy used with GnRH analogues?","options":["To increase endometriosis progression","To reduce demineralization while preserving symptom control","To cause menstruation immediately","To make the drug oral"],"answer":"To reduce demineralization while preserving symptom control"},
            {"question":"Which surgical approach is recommended for a young woman with ovarian endometriosis who wants future pregnancy?","options":["Conservative surgery","Radical hysterectomy with BSO","No intervention ever","Radiation therapy"],"answer":"Conservative surgery"},
            {"question":"Which procedure is used for an ovarian endometrioma in conservative surgery?","options":["Ovarian cystectomy","Appendectomy","Myomectomy","Endometrial ablation"],"answer":"Ovarian cystectomy"},
            {"question":"Which statement best describes adenomyosis?","options":["Endometrial tissue outside the uterus","Endometrial tissue between uterine muscle fibers","Inflammation of the cervix","A cystic ovarian tumor"],"answer":"Endometrial tissue between uterine muscle fibers"},
            {"question":"Which patient profile is most typical for adenomyosis?","options":["Young nullipara with infertility","Older multipara with abnormal uterine bleeding","Teenager with acute pelvic infection","Postmenopausal woman with vaginal atrophy"],"answer":"Older multipara with abnormal uterine bleeding"},
            {"question":"Which investigation is used for adenomyosis according to the lecture?","options":["U/S, CT scan, or MRI on the uterus","Colonoscopy only","IVP only","Laparoscopy as the only test"],"answer":"U/S, CT scan, or MRI on the uterus"},
            {"question":"What is the main treatment for adenomyosis?","options":["Hormonal treatment only","Radical surgery such as TAH + BSO","Expectant treatment only","Antibiotic therapy"],"answer":"Radical surgery such as TAH + BSO"},
            {"question":"A woman has severe pelvic pain, infertility, and a fixed retroverted uterus. What diagnosis best fits this pattern?","options":["Adenomyosis only","Pelvic endometriosis","Simple dysmenorrhea only","Ovulatory pain"],"answer":"Pelvic endometriosis"},
            {"question":"A woman with abnormal uterine bleeding, chronic pelvic pain, and a bulky symmetrical uterus most likely has what condition?","options":["Pelvic endometriosis","Adenomyosis","Cervical stenosis","Fibroadenoma"],"answer":"Adenomyosis"},
            {"question":"Which feature helps distinguish localized adenomyosis from fibroid on pathology?","options":["Presence of a capsule","No capsule","Clear mucin","Necrotic center"],"answer":"No capsule"},
            {"question":"Which statement about medical treatment of adenomyosis is correct?","options":["It is the main curative approach","It has little value because the lesions are basalis type and do not respond well to hormones","It always cures the disease completely","It is superior to surgery"],"answer":"It has little value because the lesions are basalis type and do not respond well to hormones"},
            {"question":"Endometriosis means the presence of functional endometrial tissue at abnormal sites.","options":["True","False"],"answer":"True"},
            {"question":"Adenomyosis is endometriosis of the uterine muscles.","options":["True","False"],"answer":"True"},
            {"question":"The ovary is the most common site of pelvic endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Sampson’s theory explains pelvic endometriosis by retrograde menstruation through the tubes.","options":["True","False"],"answer":"True"},
            {"question":"Meyer’s theory proposes that peritoneal epithelium can undergo metaplasia into endometrial epithelium.","options":["True","False"],"answer":"True"},
            {"question":"A first-degree relative affected by endometriosis increases a woman’s risk.","options":["True","False"],"answer":"True"},
            {"question":"Endometriosis has no reported association with autoimmune disease.","options":["True","False"],"answer":"False"},
            {"question":"Cervical stenosis may predispose to retrograde menstruation and endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Ovarian endometriosis may appear as a chocolate cyst.","options":["True","False"],"answer":"True"},
            {"question":"Pelvic endometriosis can cause adhesions in Douglas pouch and lead to a fixed retroverted uterus.","options":["True","False"],"answer":"True"},
            {"question":"Dysmenorrhea in endometriosis often starts a few days before menses and becomes worse during the period.","options":["True","False"],"answer":"True"},
            {"question":"Menuria means bleeding per rectum during menstruation.","options":["True","False"],"answer":"False"},
            {"question":"Infertility is a common manifestation of endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Laparoscopy is the first tool for diagnosis, staging, treatment, and follow-up of endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"CA-125 is specific for endometriosis and is never elevated in other diseases.","options":["True","False"],"answer":"False"},
            {"question":"Pregnancy is considered the optimum prophylaxis and curative measure for endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"Hormonal treatment is the main line of treatment for marked symptoms with minimal lesion.","options":["True","False"],"answer":"True"},
            {"question":"Danazol is currently one of the common drugs used for endometriosis.","options":["True","False"],"answer":"True"},
            {"question":"GnRH analogues may cause osteoporosis when estrogen levels remain very low for a long time.","options":["True","False"],"answer":"True"},
            {"question":"Conservative surgery for endometriosis aims to preserve the uterus and at least one ovary and one tube.","options":["True","False"],"answer":"True"},
            {"question":"Adenomyosis usually occurs in young nulliparous women.","options":["True","False"],"answer":"False"},
            {"question":"Adenomyosis commonly presents with abnormal uterine bleeding and chronic pelvic pain.","options":["True","False"],"answer":"True"},
        ...
        "Infertility":{
            ...
            {"question":"What is the approximate conception probability after one menstrual cycle of marriage?","options":["1-5%","10-15%","20-25%","80-90%"],"answer":"20-25%"},
            {"question":"Which statement best describes primary infertility?","options":["Previous conception with current inability to conceive","Never having conceived before","Infertility due only to male causes","Infertility after 10 years of marriage"],"answer":"Never having conceived before"},
            {"question":"Which situation fits secondary infertility?","options":["No prior conception ever","Previous conception even if it ended in abortion or ectopic pregnancy","Only failure after contraception use","Infertility for less than 3 months"],"answer":"Previous conception even if it ended in abortion or ectopic pregnancy"},
            {"question":"What is the usual timing of regular sexual life most helpful for conception according to the lecture?","options":["Once monthly regardless of cycle timing","3-4 times per week around ovulation","Only after menstruation ends for 1 day","Every day throughout the month without relation to ovulation"],"answer":"3-4 times per week around ovulation"},
            {"question":"Which is the most common single factor in infertility according to the lecture?","options":["Disturbed sexual life","Male factor","Female factor","Unexplained factor"],"answer":"Female factor"},
            {"question":"Which percentage best matches male factor infertility in the lecture?","options":["10%","20%","30%","50%"],"answer":"30%"},
            {"question":"Which is the main cause of reduced semen production listed in the male factor section?","options":["Cervical stenosis","Varicocele","Tubal adhesion","Endometriosis"],"answer":"Varicocele"},
            {"question":"Which of the following is a recognized cause of bilateral vas obstruction?","options":["Fibroid uterus","Gonorrhea and chlamydia","Anovulation","Asherman syndrome"],"answer":"Gonorrhea and chlamydia"},
            {"question":"Failure of semen deposition in the posterior fornix may result from all of the following EXCEPT one. Which one?","options":["Impotence","Premature ejaculation","Retrograde ejaculation","Myxoedema"],"answer":"Myxoedema"},
            {"question":"Hypospadias contributes to infertility mainly because it causes what problem?","options":["Absent testes","Improper semen deposition","Blocked uterine tubes","Reduced ovulation"],"answer":"Improper semen deposition"},
            {"question":"Which female factor is responsible for about 15-20% of infertility cases?","options":["Tubal factor","Ovarian factor","Cervical factor","Vaginal factor"],"answer":"Ovarian factor"},
            {"question":"Which is the most common cause of tubal inflammatory infertility mentioned in the lecture?","options":["Tuberculosis","Chlamydia and gonorrhea","Endometriosis","Fibroid"],"answer":"Chlamydia and gonorrhea"},
            {"question":"Which uterine factor may follow intrauterine trauma and lead to infertility?","options":["Asherman syndrome","RVF","Cervical elongation","Vaginitis"],"answer":"Asherman syndrome"},
            {"question":"Which cervical factor is an immunological cause of infertility?","options":["Cervical elongation","Presence of cervical sperm antibodies","Cervical fibroid","Cervical stenosis"],"answer":"Presence of cervical sperm antibodies"},
            {"question":"Which condition is listed under general factors causing infertility through inhibition of ovulation?","options":["Asthma","Diabetes mellitus","Appendicitis","Migraine"],"answer":"Diabetes mellitus"},
            {"question":"Which complaint is part of disturbed sexual life in the lecture?","options":["Effluvium seminis","Menorrhagia","Leucorrhea","Dysuria"],"answer":"Effluvium seminis"},
            {"question":"What is the first step in the investigation of infertility?","options":["Hysteroscopy","Complete history and physical examination of both partners","Diagnostic laparoscopy","Hormonal assay"],"answer":"Complete history and physical examination of both partners"},
            {"question":"Which factor is NOT part of the female history in infertility evaluation?","options":["Menstrual history","Obstetric history","Sexual history","Dental history"],"answer":"Dental history"},
            {"question":"Which male history point is specifically relevant to infertility?","options":["Childhood chickenpox only","Previous marriage and children","History of tonsillitis","Number of siblings"],"answer":"Previous marriage and children"},
            {"question":"What is the recommended duration of no coitus before semen analysis?","options":["12 hours","1 day","2-3 days","1 week"],"answer":"2-3 days"},
            {"question":"How many times should semen analysis be repeated?","options":["Once only","Twice, 2 months apart","Three times, weekly","Four times, within 24 hours"],"answer":"Twice, 2 months apart"},
            {"question":"Which ejaculate volume is considered normal in the WHO criteria given in the lecture?","options":["Less than 2 ml","2-6 ml","6-10 ml","More than 10 ml"],"answer":"2-6 ml"},
            {"question":"Which sperm concentration is considered normal in the WHO criteria in the lecture?","options":["Less than 20 million/ml","20-60 million/ml","60-100 million/ml","Over 200 million/ml"],"answer":"20-60 million/ml"},
            {"question":"Which motility standard is considered normal in the lecture?","options":["More than 10% progressive sperm","More than 30% progressive sperm","More than 2 sperms moving progressively forward","More than 60% motile at 2 hours"],"answer":"More than 60% motile at 2 hours"},
            {"question":"Which finding suggests teratospermia?","options":["Too many sperms","Low volume ejaculate","Increased abnormal sperm forms","No semen in ejaculate"],"answer":"Increased abnormal sperm forms"},
            {"question":"Which biochemical marker reflects seminal vesicle function?","options":["Fructose","Transferrin","Acid phosphatase","Alpha-glucosidase"],"answer":"Fructose"},
            {"question":"Which marker reflects prostate function in semen analysis?","options":["Alpha-glucosidase","Fructose","Acid phosphatase","HGF/SF"],"answer":"Acid phosphatase"},
            {"question":"Which semen finding suggests infection or immunological problems?","options":["No pus cells","Sperm agglutination >10-20%","Volume 2-4 ml","pH 7.4"],"answer":"Sperm agglutination >10-20%"},
            {"question":"Which test helps determine whether azoospermia is due to testicular damage or bilateral vas obstruction?","options":["Semen culture","Testicular biopsy","BBT chart","Cervical mucus study"],"answer":"Testicular biopsy"},
            {"question":"Which test can help identify retrograde ejaculation?","options":["Urine analysis after ejaculation","HSG","PEB","Vasography"],"answer":"Urine analysis after ejaculation"},
            {"question":"Which history feature suggests ovulation according to the lecture?","options":["Mid-ovulatory pain","Severe urinary frequency","Postcoital bleeding only","Amenorrhea"],"answer":"Mid-ovulatory pain"},
            {"question":"What is the main pattern seen on a normal BBT chart after ovulation?","options":["Monophasic curve","Sharp rise of about 0.5°C with a biphasic chart","Continuous low temperature throughout cycle","Random temperature spikes only"],"answer":"Sharp rise of about 0.5°C with a biphasic chart"},
            {"question":"What does serum progesterone level of 2-10 ng/mL suggest in the lecture?","options":["Normal luteal function","Luteal phase defect","Pregnancy always","Complete anovulation only"],"answer":"Luteal phase defect"},
            {"question":"Which test is performed on day 22 of the cycle to help detect ovulation and luteal phase defect?","options":["HSG","Premenstrual endometrial biopsy","Rubin test","Chromotubation"],"answer":"Premenstrual endometrial biopsy"},
            {"question":"Which sign on ultrasound supports ovulation during serial folliculometry?","options":["Persistent immature follicle","Disappearance of mature follicle","Large uterine fibroid","Thickened cervix"],"answer":"Disappearance of mature follicle"},
            {"question":"Which test assesses tubal patency by injecting CO2 into the uterus?","options":["Chromotubation","Rubin’s test","Falloposcopy","Hysterosonography"],"answer":"Rubin’s test"},
            {"question":"Why is CO2 preferred over air in Rubin’s test?","options":["It is cheaper","It is less soluble","It avoids the risk of air embolism and is rapidly excreted","It prevents all pelvic infection"],"answer":"It avoids the risk of air embolism and is rapidly excreted"},
            {"question":"What is the best time to perform Rubin’s test?","options":["During menstruation","Postmenstrual days 4-7","Premenstrual period","Any day regardless of cycle"],"answer":"Postmenstrual days 4-7"},
            {"question":"Which finding does NOT indicate tubal patency in Rubin’s test?","options":["Drop in manometer pressure","Bubbling sounds","Shoulder pain","No peritoneal spill on delayed film"],"answer":"No peritoneal spill on delayed film"},
            {"question":"What does hysterosalpingography add beyond Rubin’s test?","options":["Only ovarian imaging","Information about uterine cavity abnormalities and site of tubal obstruction","Direct sperm count","Diagnosis of vaginitis"],"answer":"Information about uterine cavity abnormalities and site of tubal obstruction"},
            {"question":"Which contrast medium is described as giving more detail but having a higher risk of granuloma and embolism?","options":["Water-soluble Urograffin","Oily Lipidol","Methylene blue","Normal saline"],"answer":"Oily Lipidol"},
            {"question":"Which test uses methylene blue dye and laparoscopy to show bilateral spill?","options":["Hysterosonography","Chromotubation","Rubin’s test","Kymography"],"answer":"Chromotubation"},
            {"question":"Which cervical mucus pattern is suitable for sperm penetration?","options":["Profuse, thin, clear, acellular, alkaline, and max ferning","Thick, sticky, acidic, and cellular","Absent mucus with no thread formation","Blood-stained mucus"],"answer":"Profuse, thin, clear, acellular, alkaline, and max ferning"},
            {"question":"In the fractional postcoital test, living sperms in the vaginal drop with dead sperms in cervical mucus suggest what?","options":["Normal fertility","Hostile cervical mucus due to infection","Failure of deposition","Vaginal acidity only"],"answer":"Hostile cervical mucus due to infection"},
            {"question":"Which score in Sim’s Huhner PCT represents no sperm seen per HPF?","options":["0","1","4","5"],"answer":"0"},
            {"question":"Which test is used when the postcoital test is negative to assess sperm-cervical mucus interaction?","options":["SCMC test","HSG","BBT chart","Vasography"],"answer":"SCMC test"},
            {"question":"Which general factor is listed as a cause of infertility?","options":["Anemia","Fibroid","Hydrosalpinx","Cervical fibroid"],"answer":"Anemia"},
            ...
            {"question":"Secondary infertility may follow a previous conception even if it ended in abortion, ectopic pregnancy, or vesicular mole.","options":["True","False"],"answer":"True"},
            {"question":"The incidence of infertility is about 10-15% of all women.","options":["True","False"],"answer":"True"},
            {"question":"Female factor is responsible for about 50% of infertility cases in the lecture.","options":["True","False"],"answer":"True"},
            {"question":"Male factor infertility is attributed to about 70% of all cases.","options":["True","False"],"answer":"False"},
            {"question":"Varicocele may impair fertility through hyperthermia, hypoxia, and toxins affecting the testes.","options":["True","False"],"answer":"True"},
            {"question":"Gonorrhea and chlamydia are listed as inflammatory causes of bilateral vas obstruction.","options":["True","False"],"answer":"True"},
            {"question":"Retrograde ejaculation means that most ejaculate passes into the bladder rather than out through the urethra.","options":["True","False"],"answer":"True"},
            {"question":"Hypospadias refers to a urethral opening on the dorsal aspect of the penis.","options":["True","False"],"answer":"False"},
            {"question":"Tubal factor infertility is commonly caused by salpingitis, especially due to chlamydia and gonorrhea.","options":["True","False"],"answer":"True"},
            {"question":"Asherman syndrome is a cervical cause of infertility.","options":["True","False"],"answer":"False"},
            {"question":"Vaginismus is a violent reflex spasm of pelvic floor and abdominal muscles during attempted intercourse.","options":["True","False"],"answer":"True"},
            {"question":"Unexplained infertility means no cause is found after examination and routine investigations of both partners.","options":["True","False"],"answer":"True"},
            {"question":"Semen analysis should be performed after 2-3 days of no coitus.","options":["True","False"],"answer":"True"},
            {"question":"Semen analysis should usually be repeated twice, 2 months apart.","options":["True","False"],"answer":"True"},
            {"question":"Normal semen volume in the lecture is 2-6 ml.","options":["True","False"],"answer":"True"},
            {"question":"Azoospermia means low sperm motility.","options":["True","False"],"answer":"False"},
            {"question":"Motility above 60% at 2 hours after ejaculation is considered normal in the lecture.","options":["True","False"],"answer":"True"},
            {"question":"Pus cells more than 5 per HPF are considered normal in semen microscopy.","options":["True","False"],"answer":"False"},
            {"question":"Fructose is used as a biochemical marker of seminal vesicle function.","options":["True","False"],"answer":"True"},
            {"question":"Serum progesterone of 2-10 ng/mL may suggest luteal phase defect.","options":["True","False"],"answer":"True"},
            {"question":"Rubin’s test uses air injection into the uterus to avoid embolism.","options":["True","False"],"answer":"False"},
            {"question":"The best time for Rubin’s test is postmenstrual days 4-7.","options":["True","False"],"answer":"True"},
            {"question":"HSG can reveal uterine abnormalities such as bicornuate uterus and submucous fibroid.","options":["True","False"],"answer":"True"},
            {"question":"Oily contrast media in HSG is associated with more oil granuloma than water-soluble media.","options":["True","False"],"answer":"True"},
            {"question":"Chromotubation uses methylene blue dye during laparoscopy.","options":["True","False"],"answer":"True"},
            {"question":"In the cervical mucus study, mucus suitable for sperm penetration should be thick and acidic.","options":["True","False"],"answer":"False"},
            {"question":"A normal fractional postcoital test shows living sperms in both the vaginal and cervical drops.","options":["True","False"],"answer":"True"},
            {"question":"A score of 0 in Sim’s Huhner PCT means no sperm are seen per HPF.","options":["True","False"],"answer":"True"},
        ...
        "Polycystic Ovary Syndrome":{
            ...
            {"question":"Which hormonal pattern is most typical in PCOS?","options":["Low LH and high FSH","LH:FSH ratio around 3:1","FSH predominance with low androgen","Normal LH with high progesterone"],"answer":"LH:FSH ratio around 3:1"},
            {"question":"Which of the following is a common clinical presentation of PCOS?","options":["Regular ovulation with heavy cyclic bleeding only","Anovulation with infertility and oligohypomenorrhea","Premature menopause in adolescence","Primary amenorrhea in all cases"],"answer":"Anovulation with infertility and oligohypomenorrhea"},
            {"question":"What skin finding is classically linked with insulin resistance in PCOS?","options":["Pallor of palms","Acanthosis nigricans","Butterfly rash","Telangiectasia"],"answer":"Acanthosis nigricans"},
            {"question":"Which biochemical pattern is most consistent with PCOS?","options":["Decreased androgens with decreased insulin","Increased testosterone, androstenedione, DHEA and DHEA-S","Increased progesterone with low LH","Low estrogen with high FSH"],"answer":"Increased testosterone, androstenedione, DHEA and DHEA-S"},
            {"question":"Which ultrasound finding is most suggestive of PCOS?","options":["Single large dominant follicle","Necklace appearance of peripheral follicles","Collapsed uterine cavity","Thickened endometrial stripe only"],"answer":"Necklace appearance of peripheral follicles"},
            {"question":"According to ESHRE 2003, PCOS diagnosis requires how many of the listed criteria?","options":["One out of two","Two out of three","Three out of four","All three plus obesity"],"answer":"Two out of three"},
            {"question":"Which is one of the ESHRE 2003 diagnostic criteria for PCOS?","options":["High prolactin alone","Oligo/anovulation","Thin endometrium only","Absent ovaries"],"answer":"Oligo/anovulation"},
            {"question":"Which ultrasound threshold is part of the diagnostic criteria for PCOS?","options":["More than 5 follicles, 10-15 mm each","More than 10 peripheral follicles, 2-9 mm in diameter","Any follicle larger than 20 mm","No visible follicles"],"answer":"More than 10 peripheral follicles, 2-9 mm in diameter"},
            {"question":"Which ovarian volume supports the diagnosis of PCOS on ultrasound?","options":["Less than 5 ml","More than 10 ml","Exactly 8 ml","More than 20 ml only"],"answer":"More than 10 ml"},
            {"question":"Which of the following is an effect of obesity in PCOS?","options":["Decreased fasting insulin","Increased SHBG and lower free testosterone","Increased fasting insulin with reduced SHBG","Reduced peripheral conversion of androgen to estrone"],"answer":"Increased fasting insulin with reduced SHBG"},
            {"question":"What is the normal BMI range mentioned in the lecture?","options":["15-20","20-25","25-30","30-35"],"answer":"20-25"},
            {"question":"A BMI above 30 in the lecture is classified as what?","options":["Normal weight","Overweight","Extreme obesity","Underweight"],"answer":"Extreme obesity"},
            {"question":"Which disorder is NOT listed among the PCOS-like syndromes in the differential diagnosis table?","options":["CAH","Cushing syndrome","Androgen-secreting tumour","Endometriosis"],"answer":"Endometriosis"},
            {"question":"Which feature favors CAH rather than PCOS in the differential diagnosis table?","options":["Onset at 15-25 years","Congenital onset","Rare virilization","Suppressed cortisol after dexamethasone"],"answer":"Congenital onset"},
            {"question":"Which feature favors Cushing syndrome rather than PCOS?","options":["Suppressed cortisol after dexamethasone","Not suppressed cortisol after dexamethasone","Normal testosterone always","Low LH with high FSH"],"answer":"Not suppressed cortisol after dexamethasone"},
            {"question":"What is the first general line of management in PCOS before other treatment strategies?","options":["Start ovulation induction immediately","Weight reduction is mandatory","Perform laparotomy","Proceed directly to IVF"],"answer":"Weight reduction is mandatory"},
            {"question":"Why is smoking reduction advised in PCOS?","options":["It decreases ovarian volume","It increases adrenal androgen secretion","It improves insulin sensitivity instantly","It raises FSH bioactivity"],"answer":"It increases adrenal androgen secretion"},
            {"question":"Which drug is used to improve insulin sensitivity in PCOS?","options":["Metformin","Aspirin","Progesterone only","Danazol"],"answer":"Metformin"},
            {"question":"Which drug may be added when hyperprolactinemia is a problem in PCOS?","options":["Bromocriptine","Dexamethasone","Clomiphene","Rosiglitazone"],"answer":"Bromocriptine"},
            {"question":"Which approach is mentioned for treating hyperinsulinemia in PCOS?","options":["Increase insulin secretion directly","Use metformin or thiazolidinediones such as pioglitazone or rosiglitazone","Avoid all exercise","Use only progesterone"],"answer":"Use metformin or thiazolidinediones such as pioglitazone or rosiglitazone"},
            {"question":"Which procedure may be used when androgen excess is marked in PCOS?","options":["Wedge resection or ovarian drilling","Hysterectomy","Cervical cerclage","Endometrial ablation"],"answer":"Wedge resection or ovarian drilling"},
            {"question":"What is the purpose of clomiphene in the management algorithm shown in the lecture?","options":["To treat hirsutism directly","To induce ovulation after baseline evaluation and metformin if not pregnant","To replace liver function tests","To suppress LH permanently"],"answer":"To induce ovulation after baseline evaluation and metformin if not pregnant"},
            {"question":"According to the management algorithm, what should be done once pregnancy is confirmed?","options":["Continue metformin indefinitely","Stop metformin","Add ovarian drilling immediately","Start GnRH agonist"],"answer":"Stop metformin"},
            {"question":"Which is listed as a next-step option if pregnancy does not occur after 12 cycles?","options":["No further management","Gonadotrophins, ovarian drilling, IUI, or IVF","Only antibiotics","Only vitamin therapy"],"answer":"Gonadotrophins, ovarian drilling, IUI, or IVF"},
            {"question":"PCOS was first described by Stein and Leventhal in 1935.","options":["True","False"],"answer":"True"},
            {"question":"Insulin resistance is part of the recent theory of PCOS.","options":["True","False"],"answer":"True"},
            {"question":"PCOS may present with anovulation, infertility, oligohypomenorrhea, or amenorrhea.","options":["True","False"],"answer":"True"},
            {"question":"Acanthosis nigricans can be seen in PCOS.","options":["True","False"],"answer":"True"},
            {"question":"The usual LH:FSH ratio in PCOS is 1:3.","options":["True","False"],"answer":"False"},
            {"question":"PCOS is associated with increased androgens such as testosterone, androstenedione, DHEA, and DHEA-S.","options":["True","False"],"answer":"True"},
            {"question":"Transvaginal ultrasound may show a necklace appearance in PCOS.","options":["True","False"],"answer":"True"},
            {"question":"According to ESHRE 2003, all three diagnostic criteria are mandatory for PCOS diagnosis.","options":["True","False"],"answer":"False"},
            {"question":"Diagnosis of PCOS can be made when two of three ESHRE criteria are present.","options":["True","False"],"answer":"True"},
            {"question":"Obesity may worsen PCOS by increasing fasting insulin and lowering SHBG.","options":["True","False"],"answer":"True"},
            {"question":"BMI 20-25 is considered obesity in the lecture.","options":["True","False"],"answer":"False"},
            {"question":"Smoking reduction is recommended in PCOS because smoking increases adrenal androgen secretion.","options":["True","False"],"answer":"True"},
            {"question":"Hyperinsulinemia in PCOS may increase ovarian androgens through IGF-1.","options":["True","False"],"answer":"True"},
            {"question":"Dopamine agonists may be added if prolactin is increased in PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Ovarian drilling may be used to manage increased androgen levels in PCOS.","options":["True","False"],"answer":"True"},
            {"question":"OCPs may be used to regulate oligohypomenorrhea in PCOS.","options":["True","False"],"answer":"True"},
            {"question":"Weight reduction is optional and not necessary before treatment in PCOS.","options":["True","False"],"answer":"False"},
            {"question":"Androgen-secreting tumour is one of the differential diagnoses of hirsutism with oligomenorrhea.","options":["True","False"],"answer":"True"},
